...
var require_utils3 = __commonJS({
  "node_modules/qrcode/lib/renderer/utils.js"(exports) {
    function hex2rgba(hex) {
      ...
      if (hexCode.length === 6)
        hexCode.push("F", "F");
      const hexValue4 = parseInt(hexCode.join(""), 16);
      return {
        r: hexValue4 >> 24 & 255,
        g: hexValue4 >> 16 & 255,
        b: hexValue4 >> 8 & 255,
...
// node_modules/@rainbow-me/rainbowkit/dist/chunk-HOY3SQCF.js
...
var arbitrumIcon = {
  ...
  iconUrl: async () => (await import("./arbitrum-RJBKFWDE-2THFZ2IK.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-GTODSNSK-XZK2MZVD.js")).default
};
var baseIcon = {
  iconBackground: "#0052ff",
  iconUrl: async () => (await import("./base-JHU6THII-MRRASH33.js")).default
};
var bscIcon = {
  iconBackground: "#ebac0e",
  iconUrl: async () => (await import("./bsc-SVDDT6HW-BHI6N6KV.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-TCZSTHSI-U3S6T2ND.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-VJNBZ2P3-LE5GL6MD.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-3QUIF6AD-4WC2S2Q5.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-3QOW27A7-FUUZSOMK.js")).default
};
...
var src = async () => (await import("./assets-7THATBKH-GBWAEKNO.js")).default;
...
var src2 = async () => (await import("./login-EJZTP74Q-K2NNVFYO.js")).default;
...
var signInIcon = async () => (await import("./sign-3FIRYJVD-2WO2FDZI.js")).default;
...
var src3 = async () => (await import("./create-GVGWOEGN-NUTUMFTU.js")).default;
...
var src4 = async () => (await import("./refresh-J4PXTKTR-2GY2RJE2.js")).default;
...
var src5 = async () => (await import("./scan-RESLZYEA-QB2YULUW.js")).default;
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Arc":
      return (await import("./Arc-ZT5MU7SE-4WZO7GJA.js")).default;
    case "Brave":
      return (await import("./Brave-AYENFWW6-QFZJQAW2.js")).default;
    case "Chrome":
      return (await import("./Chrome-J3SNM3VC-D64X6SFC.js")).default;
    case "Edge":
      return (await import("./Edge-L7ZZC477-KQX637PC.js")).default;
    case "Firefox":
      return (await import("./Firefox-JUUNEJSG-VU4VLOFX.js")).default;
    case "Opera":
      return (await import("./Opera-6J2CQ7O6-JWM63O66.js")).default;
    case "Safari":
      return (await import("./Safari-HSMWXLX5-4V2YRH7X.js")).default;
    default:
      return (await import("./Browser-MZYY2QO6-NTBIEAI3.js")).default;
  }
};
    ...
    try {
      ...
      if (!isChainApproved && namespaceMethods.includes(ADD_ETH_CHAIN_METHOD)) {
        await provider.request({
          ...
          params: [
            {
              chainId: (0, import_utils3.hexValue)(chain.id),
              blockExplorerUrls: [(_a = chain.blockExplorers) == null ? void 0 : _a.default.url],
      ...
      await provider.request({
        ...
        params: [{ chainId: (0, import_utils3.hexValue)(chainId) }]
      });
      return chain;
    } catch (error) {
...
initProvider_fn = async function() {
  const {
    ...
    OPTIONAL_EVENTS,
    OPTIONAL_METHODS
  } = await import("./index.es-E2K7DVKY.js");
...
var CoinbaseWalletConnector = class extends Connector {
  ...
  async getProvider() {
    var _a;
    if (!__privateGet(this, _provider2)) {
      let CoinbaseWalletSDK = (await import("./dist-EHMGFBOT.js")).default;
...
var WalletConnectLegacyConnector = class extends Connector {
  constructor(config) {
    ...
    __publicField(this, "onAccountsChanged", (accounts) => {
      if (accounts.length === 0)
        ...
        this.emit("change", { account: (0, import_utils6.getAddress)(accounts[0]) });
    });
    __publicField(this, "onChainChanged", (chainId) => {
      const id = normalizeChainId(chainId);
      const unsupported = this.isChainUnsupported(id);
  ...
  async connect({ chainId } = {}) {
    ...
    try {
      ...
      const accounts = await provider.enable();
      const account = (0, import_utils6.getAddress)(accounts[0]);
      const id = await this.getChainId();
      const unsupported = this.isChainUnsupported(id);
  ...
  async getProvider({
    ...
    if (!__privateGet(this, _provider3) || chainId || create) {
      ...
      const WalletConnectProvider = (await import("./esm-WDIS2TPH.js")).default;
...
switchChain_fn = async function(chainId) {
  const provider = await this.getProvider();
  const id = (0, import_utils6.hexValue)(chainId);
  try {
    await Promise.race([
      provider.request({
        method: "wallet_switchEthereumChain",
...
var SafeConnector = class extends Connector {
  ...
  async getAccount() {
    ...
    return (0, import_utils7.getAddress)(accounts[0]);
  }
  async getChainId() {
    const provider = await this.getProvider();
    if (!provider)
...
var braveWallet = ({
  ...
  return {
    id: "brave",
    name: "Brave Wallet",
    iconUrl: async () => (await import("./braveWallet-VWIUQB2U-6DB5B5V3.js")).default,
    iconBackground: "#fff",
...
var coinbaseWallet = ({
  ...
  return {
    ...
    shortName: "Coinbase",
    iconUrl: async () => (await import("./coinbaseWallet-VVDQG4AO-P6O2KAP7.js")).default,
    iconAccent: "#2c5ff6",
...
var injectedWallet = ({
  ...
  id: "injected",
  name: "Browser Wallet",
  iconUrl: async () => (await import("./injectedWallet-UM67Z7WG-4ZTJRDJR.js")).default,
  iconBackground: "#fff",
...
var metaMaskWallet = ({
  ...
  return {
    id: "metaMask",
    name: "MetaMask",
    iconUrl: async () => (await import("./metaMaskWallet-F3BDZH5W-I3JCQM5Z.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    id: "rainbow",
    name: "Rainbow",
    iconUrl: async () => (await import("./rainbowWallet-KSMGN6MJ-V37OCP2J.js")).default,
...
var safeWallet = ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-3KUD3U5G-FLTR5VHC.js")).default,
...
var walletConnectWallet = ({
  ...
  id: "walletConnect",
  name: "WalletConnect",
  iconUrl: async () => (await import("./walletConnectWallet-GTSESN7Q-YEIRRZH3.js")).default,
