...
var require_sha256 = __commonJS({
  "node_modules/@stablelib/sha256/lib/sha256.js"(exports) {
    ...
    function hashBlocks(w4, v2, p4, pos, len) {
      while (len >= 64) {
        var a2 = v2[0];
        var b5 = v2[1];
        var c2 = v2[2];
        ...
        for (var i2 = 0; i2 < 16; i2++) {
          var j5 = pos + i2 * 4;
          w4[i2] = binary_1.readUint32BE(p4, j5);
        }
        ...
        for (var i2 = 0; i2 < 64; i2++) {
          var t1 = (((e >>> 6 | e << 32 - 6) ^ (e >>> 11 | e << 32 - 11) ^ (e >>> 25 | e << 32 - 25)) + (e & f4 ^ ~e & g4) | 0) + (h2 + (K2[i2] + w4[i2] | 0) | 0) | 0;
          var t2 = ((a2 >>> 2 | a2 << 32 - 2) ^ (a2 >>> 13 | a2 << 32 - 13) ^ (a2 >>> 22 | a2 << 32 - 22)) + (a2 & b5 ^ a2 & c2 ^ b5 & c2) | 0;
          h2 = g4;
          g4 = f4;
          f4 = e;
          e = d2 + t1 | 0;
...
var require_x25519 = __commonJS({
  "node_modules/@stablelib/x25519/lib/x25519.js"(exports) {
    ...
    function scalarMult(n2, p4) {
      ...
      const a2 = gf(), b5 = gf(), c2 = gf(), d2 = gf(), e = gf(), f4 = gf();
    ...
    if (g4[n2])
      i2[n2] = function(v2) {
        return new Promise(function(a2, b5) {
          q4.push([n2, v2, a2, b5]) > 1 || resume(n2, v2);
        });
      };
  }
...
function __asyncDelegator(o) {
  ...
  function verb(n2, f4) {
    i2[n2] = o[n2] ? function(v2) {
      return (p4 = !p4) ? { value: __await(o[n2](v2)), done: n2 === "return" } : f4 ? f4(v2) : v2;
    } : f4;
  }
}
...
function __asyncDelegator2(o) {
  ...
  function verb(n2, f4) {
    i2[n2] = o[n2] ? function(v2) {
      return (p4 = !p4) ? { value: __await2(o[n2](v2)), done: n2 === "return" } : f4 ? f4(v2) : v2;
    } : f4;
  }
}
...
function __asyncDelegator3(o) {
  ...
  function verb(n2, f4) {
    i2[n2] = o[n2] ? function(v2) {
      return (p4 = !p4) ? { value: __await3(o[n2](v2)), done: n2 === "return" } : f4 ? f4(v2) : v2;
    } : f4;
  }
}
...
function __createBinding4(o, m3, k2, k22) {
  if (k22 === void 0)
    k22 = k2;
  o[k22] = m3[k2];
}
...
function __asyncDelegator4(o) {
  ...
  function verb(n2, f4) {
    i2[n2] = o[n2] ? function(v2) {
      return (p4 = !p4) ? { value: __await4(o[n2](v2)), done: n2 === "return" } : f4 ? f4(v2) : v2;
    } : f4;
  }
}
...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function edadd(p4, q4) {
      const a2 = gf(), b5 = gf(), c2 = gf(), d2 = gf(), e = gf(), f4 = gf(), g4 = gf(), h2 = gf(), t = gf();
      sub(a2, p4[1], p4[0]);
      sub(t, q4[1], q4[0]);
      mul(a2, a2, t);
      add(b5, p4[0], p4[1]);
    ...
    function modL(r, x2) {
      ...
      for (i2 = 63; i2 >= 32; --i2) {
        ...
        for (j5 = i2 - 32, k2 = i2 - 12; j5 < k2; ++j5) {
          x2[j5] += carry - 16 * x2[i2] * L4[j5 - (i2 - 32)];
...
function Un(e, n2) {
  const t = ue.sharedKey(fromString2(e, f), fromString2(n2, f)), r = new import_hkdf.HKDF(import_sha256.SHA256, t).expand(Q);
...
function Cn(e) {
  const n2 = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e.symKey, f)), { sealed: t, iv: r } = Z(e.encoded), o = n2.open(r, t);
  if (o === null)
...
function Z(e) {
  const n2 = fromString2(e, L), t = n2.slice(Rn, Oe), r = Oe;
  if ($(t) === U) {
    const l = r + Q, d2 = l + J, c2 = n2.slice(r, l), u4 = n2.slice(l, d2), a2 = n2.slice(d2);
    return { type: t, sealed: a2, iv: u4, senderPublicKey: c2 };
  }
...
function Dn(e, n2) {
  const t = Z(e);
  return Pe({ type: $(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? toString2(t.senderPublicKey, f) : void 0, receiverPublicKey: n2 == null ? void 0 : n2.receiverPublicKey });
}
function Pe(e) {
...
function Ce(e, n2) {
  let t = V.parse(e);
  return t = we(we({}, t), n2), e = V.stringify(t), e;
}
function Fn() {
...
function Ve() {
  var e;
  const n2 = j();
  return n2 === N.browser ? [n2, ((e = (0, import_window_getters.getLocation)()) == null ? void 0 : e.host) || "unknown"].join(":") : n2;
}
function Me(e, n2, t) {
  const r = De(), o = Ve();
...
function qn({ protocol: e, version: n2, relayUrl: t, sdkVersion: r, auth: o, projectId: s, useOnCloseEvent: i2 }) {
  const l = t.split("?"), d2 = Me(e, n2, r), c2 = { auth: o, ua: d2, projectId: s, useOnCloseEvent: i2 || void 0 }, u4 = Ce(l[1] || "", c2);
  return l[0] + "?" + u4;
}
function O(e, n2) {
...
async function ct({ id: e, topic: n2, wcDeepLink: t }) {
  try {
    ...
    const s = `${o}/wc?requestId=${e}&sessionTopic=${n2}`, i2 = j();
    i2 === N.browser ? s.startsWith("https://") ? window.open(s, "_blank", "noreferrer noopener") : window.open(s, "_self", "noreferrer noopener") : i2 === N.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(s);
  } catch (r) {
    console.error(r);
  }
}
...
function mt(e) {
  ...
  return { protocol: r, topic: ze(o[0]), version: parseInt(o[1], 10), symKey: i2.symKey, relay: qe(i2) };
}
function ze(e) {
...
function Rt(e, n2) {
  ...
  return O(o, r) ? (r.forEach((i2) => {
    const { accounts: l, methods: d2, events: c2 } = e.namespaces[i2], u4 = R(l), a2 = t[i2];
    (!O(k(i2, a2), u4) || !O(a2.methods, d2) || !O(a2.events, c2)) && (s = false);
  }), s) : false;
}
function D(e) {
...
function _t(e, n2) {
  let t = null;
  return m(e == null ? void 0 : e.publicKey, false) || (t = b("MISSING_OR_INVALID", `${n2} controller public key should be a string`)), t;
}
function oe(e) {
  let n2 = true;
...
function en(e, n2, t) {
  let r = null;
  return C(n2) && n2.length ? n2.forEach((o) => {
...
function tn(e, n2) {
  ...
  return C(e) ? e.forEach((r) => {
    t || Xe(r) || (t = w("UNSUPPORTED_ACCOUNTS", `${n2}, account ${r} should be a string and conform to "namespace:chainId:address" format`));
  }) : t = w("UNSUPPORTED_ACCOUNTS", `${n2}, accounts should be an array of strings conforming to "namespace:chainId:address" format`), t;
}
function rn(e, n2) {
  let t = null;
  return Object.values(e).forEach((r) => {
...
function on(e, n2) {
  let t = null;
  return oe(e == null ? void 0 : e.methods) ? oe(e == null ? void 0 : e.events) || (t = w("UNSUPPORTED_EVENTS", `${n2}, events should be an array of strings or empty array for no events`)) : t = w("UNSUPPORTED_METHODS", `${n2}, methods should be an array of strings or empty array for no methods`), t;
}
function se(e, n2) {
  let t = null;
  return Object.values(e).forEach((r) => {
...
function $t(e, n2, t) {
  ...
  if (e && H(e)) {
    ...
    r = b("MISSING_OR_INVALID", `${n2}, ${t} should be an object with data`);
  return r;
}
function sn(e, n2) {
  let t = null;
  if (e && H(e)) {
    ...
    t = b("MISSING_OR_INVALID", `${n2}, namespaces should be an object with data`);
  return t;
}
function cn(e) {
...
function an(e, n2, t) {
  let r = null;
  const o = Ht(e), s = qt(n2), i2 = Object.keys(o), l = Object.keys(s), d2 = un(Object.keys(e)), c2 = un(Object.keys(n2)), u4 = d2.filter((a2) => !c2.includes(a2));
  return u4.length && (r = b("NON_CONFORMING_NAMESPACES", `${t} namespaces keys don't satisfy requiredNamespaces.
      Required: ${u4.toString()}
      Received: ${Object.keys(n2).toString()}`)), O(i2, l) || (r = b("NON_CONFORMING_NAMESPACES", `${t} namespaces chains don't satisfy required namespaces.
      Required: ${i2.toString()}
      Approved: ${l.toString()}`)), Object.keys(n2).forEach((a2) => {
    if (!a2.includes(":") || r)
      return;
    const g4 = R(n2[a2].accounts);
    g4.includes(a2) || (r = b("NON_CONFORMING_NAMESPACES", `${t} namespaces accounts don't satisfy namespace accounts for ${a2}
        Required: ${a2}
        Approved: ${g4.toString()}`));
  }), i2.forEach((a2) => {
    r || (O(o[a2].methods, s[a2].methods) ? O(o[a2].events, s[a2].events) || (r = b("NON_CONFORMING_NAMESPACES", `${t} namespaces events don't satisfy namespace events for ${a2}`)) : r = b("NON_CONFORMING_NAMESPACES", `${t} namespaces methods don't satisfy namespace methods for ${a2}`));
  }), r;
}
function Ht(e) {
  const n2 = {};
...
function Fi(r, e) {
  ...
  function D3(u4) {
    ...
    if (u4.length === 0)
      return "";
    for (var y3 = 0, A = 0, v2 = 0, R2 = u4.length; v2 !== R2 && u4[v2] === 0; )
      v2++, y3++;
    for (var T = (R2 - v2) * l + 1 >>> 0, m3 = new Uint8Array(T); v2 !== R2; ) {
      for (var S4 = u4[v2], x2 = 0, I2 = T - 1; (S4 !== 0 || x2 < A) && I2 !== -1; I2--, x2++)
        S4 += 256 * m3[I2] >>> 0, m3[I2] = S4 % o >>> 0, S4 = S4 / o >>> 0;
      if (S4 !== 0)
        throw new Error("Non-zero carry");
      A = x2, v2++;
    }
    for (var P2 = T - A; P2 !== T && m3[P2] === 0; )
      P2++;
    for (var B2 = h2.repeat(y3); P2 < T; ++P2)
      B2 += r.charAt(m3[P2]);
    return B2;
  }
  function b5(u4) {
    ...
    var y3 = 0;
    if (u4[y3] !== " ") {
      for (var A = 0, v2 = 0; u4[y3] === h2; )
        A++, y3++;
      for (var R2 = (u4.length - y3) * d2 + 1 >>> 0, T = new Uint8Array(R2); u4[y3]; ) {
        var m3 = t[u4.charCodeAt(y3)];
        if (m3 === 255)
          return;
        for (var S4 = 0, x2 = R2 - 1; (m3 !== 0 || S4 < v2) && x2 !== -1; x2--, S4++)
          m3 += o * T[x2] >>> 0, T[x2] = m3 % 256 >>> 0, m3 = m3 / 256 >>> 0;
        if (m3 !== 0)
          throw new Error("Non-zero carry");
        v2 = S4, y3++;
      }
      if (u4[y3] !== " ") {
        for (var I2 = R2 - v2; I2 !== R2 && T[I2] === 0; )
          I2++;
        for (var P2 = new Uint8Array(A + (R2 - I2)), B2 = A; I2 !== R2; )
          P2[B2++] = T[I2++];
        return P2;
      }
    }
  ...
  return { encode: D3, decodeUnsafe: b5, decode: k2 };
}
var $i = Fi;
var Mi = $i;
var Oe2 = (r) => {
...
var Yi = (r, e, t, i2) => {
  ...
  for (let l = 0; l < n2; ++l) {
    ...
    h2 = h2 << t | D3, o += t, o >= 8 && (o -= 8, a2[d2++] = 255 & h2 >> o);
  }
  if (o >= t || 255 & h2 << 8 - o)
    throw new SyntaxError("Unexpected end of data");
  return a2;
...
var p2 = ({ name: r, prefix: e, bitsPerChar: t, alphabet: i2 }) => H2({ prefix: e, name: r, encode(s) {
  return Gi(s, i2, t);
}, decode(s) {
  return Yi(s, i2, t, r);
} });
...
var Wi = p2({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
var Xi = Object.freeze({ __proto__: null, base2: Wi });
var Zi = p2({ prefix: "7", name: "base8", alphabet: "01234567", bitsPerChar: 3 });
...
var is = p2({ prefix: "f", name: "base16", alphabet: "0123456789abcdef", bitsPerChar: 4 });
var ss = p2({ prefix: "F", name: "base16upper", alphabet: "0123456789ABCDEF", bitsPerChar: 4 });
var rs = Object.freeze({ __proto__: null, base16: is, base16upper: ss });
var ns = p2({ prefix: "b", name: "base32", alphabet: "abcdefghijklmnopqrstuvwxyz234567", bitsPerChar: 5 });
var as = p2({ prefix: "B", name: "base32upper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", bitsPerChar: 5 });
var os = p2({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 });
var hs = p2({ prefix: "C", name: "base32padupper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", bitsPerChar: 5 });
var cs = p2({ prefix: "v", name: "base32hex", alphabet: "0123456789abcdefghijklmnopqrstuv", bitsPerChar: 5 });
var us = p2({ prefix: "V", name: "base32hexupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV", bitsPerChar: 5 });
var ls = p2({ prefix: "t", name: "base32hexpad", alphabet: "0123456789abcdefghijklmnopqrstuv=", bitsPerChar: 5 });
var ds = p2({ prefix: "T", name: "base32hexpadupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV=", bitsPerChar: 5 });
var gs = p2({ prefix: "h", name: "base32z", alphabet: "ybndrfg8ejkmcpqxot1uwisza345h769", bitsPerChar: 5 });
...
var ws = p2({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 });
var vs = p2({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 });
var Is = p2({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 });
var Cs = p2({ prefix: "U", name: "base64urlpad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=", bitsPerChar: 6 });
...
var Le = Js;
var Fe2 = (r, e, t = 0) => (Le.encode(r, e, t), e);
var $e2 = (r) => Le.encodingLength(r);
var oe2 = (r, e) => {
  const t = e.byteLength, i2 = $e2(r), s = i2 + $e2(t), n2 = new Uint8Array(s + t);
  return Fe2(r, n2, 0), Fe2(t, n2, i2), n2.set(e, s), new Hs(r, t, e, n2);
};
var Hs = class {
  constructor(e, t, i2, s) {
...
var Me2 = ({ name: r, code: e, encode: t }) => new Ws(r, e, t);
var Ws = class {
  constructor(e, t, i2) {
...
var Xs = Me2({ name: "sha2-256", code: 18, encode: Ke("SHA-256") });
var Zs = Me2({ name: "sha2-512", code: 19, encode: Ke("SHA-512") });
var Qs = Object.freeze({ __proto__: null, sha256: Xs, sha512: Zs });
var ke = 0;
var er = "identity";
var Be = Oe2;
var tr = (r) => oe2(ke, Be(r));
var ir = { code: ke, name: er, encode: Be, digest: tr };
...
var vt = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.keychain = /* @__PURE__ */ new Map(), this.name = Ze2, this.version = Qe2, this.initialized = false, this.storagePrefix = O2, this.init = async () => {
      if (!this.initialized) {
      ...
      if (typeof s > "u") {
        const { message: n2 } = b("NO_MATCHING_KEY", `${this.name}: ${i2}`);
        throw new Error(n2);
      }
      return s;
    }, this.del = async (i2) => {
...
var It = class {
  constructor(e, t, i2) {
    this.core = e, this.logger = t, this.name = We, this.initialized = false, this.init = async () => {
      ...
      this.isInitialized();
      const n2 = await this.getClientSeed(), a2 = generateKeyPair2(n2), o = An(), h2 = Xe2;
      ...
      if (Vn(o)) {
        const b5 = o.senderPublicKey, k2 = o.receiverPublicKey;
        s = await this.generateSharedKey(b5, k2);
      }
      const d2 = this.getSymKey(s), { type: l, senderPublicKey: D3 } = o;
      return jn({ type: l, symKey: d2, message: h2, senderPublicKey: D3 });
    }, this.decode = async (s, n2, a2) => {
      this.isInitialized();
      const o = Dn(n2, a2);
      if (Vn(o)) {
        const l = o.receiverPublicKey, D3 = o.senderPublicKey;
        s = await this.generateSharedKey(l, D3);
      }
...
var lr = class extends u {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events4.EventEmitter(), this.name = st2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time3.toMiliseconds)(import_time3.TEN_SECONDS), this.queueTimeout = (0, import_time3.toMiliseconds)(import_time3.FIVE_SECONDS), this.needsTransportRestart = false, this.publish = async (i2, s, n2) => {
      this.logger.debug("Publishing Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i2, message: s, opts: n2 } });
      try {
        const a2 = (n2 == null ? void 0 : n2.ttl) || it2, o = at(n2), h2 = (n2 == null ? void 0 : n2.prompt) || false, d2 = (n2 == null ? void 0 : n2.tag) || 0, l = (n2 == null ? void 0 : n2.id) || getBigIntRpcId().toString(), D3 = { topic: i2, message: s, opts: { ttl: a2, relay: o, prompt: h2, tag: d2, id: l } }, b5 = setTimeout(() => this.queue.set(l, D3), this.queueTimeout);
        try {
          await await et(this.rpcPublish(i2, s, a2, o, h2, d2, l), this.publishTimeout), clearTimeout(b5), this.relayer.events.emit(g2.publish, D3);
        } catch {
  ...
  rpcPublish(e, t, i2, s, n2, a2, o) {
    var h2, d2, l, D3;
    const b5 = { method: ut(s.protocol).publish, params: { topic: e, message: t, ttl: i2, prompt: n2, tag: a2 }, id: o };
    return I((h2 = b5.params) == null ? void 0 : h2.prompt) && ((d2 = b5.params) == null || delete d2.prompt), I((l = b5.params) == null ? void 0 : l.tag) && ((D3 = b5.params) == null || delete D3.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: b5 }), this.relayer.request(b5);
  }
  onPublish(e) {
    this.queue.delete(e);
  }
...
var pe2 = (r, e) => pr(r, Dr(e));
var Tt2 = class extends d {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.subscriptions = /* @__PURE__ */ new Map(), this.topicMap = new dr(), this.events = new import_events4.EventEmitter(), this.name = gt, this.version = pt2, this.pending = /* @__PURE__ */ new Map(), this.cached = [], this.initialized = false, this.pendingSubscriptionWatchLabel = "pending_sub_watch_label", this.pollingInterval = 20, this.storagePrefix = O2, this.subscribeTimeout = 1e4, this.restartInProgress = false, this.batchSubscribeTopicsLimit = 500, this.init = async () => {
  ...
  async unsubscribeById(e, t, i2) {
    ...
    try {
      ...
      const n2 = w("USER_DISCONNECTED", `${this.name}, ${e}`);
  ...
  getSubscription(e) {
    ...
    if (!t) {
      const { message: i2 } = b("NO_MATCHING_KEY", `${this.name}: ${e}`);
      throw new Error(i2);
    }
    return t;
  }
  deleteSubscription(e, t) {
    ...
    this.subscriptions.delete(e), this.topicMap.delete(i2.topic, e), this.events.emit(C2.deleted, pe2(K({}, i2), { reason: t }));
  }
  async persist() {
  ...
  async batchSubscribe(e) {
    ...
    C(t) && this.onBatchSubscribe(t.map((i2, s) => pe2(K({}, e[s]), { id: i2 })));
  }
  async onConnect() {
...
var Pt2 = (r, e, t) => e in r ? mr(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
var wr = (r, e) => {
  for (var t in e || (e = {}))
    Er.call(e, t) && Pt2(r, t, e[t]);
  if (St2)
    for (var t of St2(e))
      fr.call(e, t) && Pt2(r, t, e[t]);
  return r;
};
var Ot = class extends g {
  constructor(e) {
    super(e), this.protocol = "wc", this.version = 2, this.events = new import_events4.EventEmitter(), this.name = at2, this.transportExplicitlyClosed = false, this.initialized = false, this.reconnecting = false, this.connectionStatusPollingInterval = 20, this.staleConnectionErrors = ["socket hang up", "socket stalled"], this.request = async (t) => {
    ...
    }, this.core = e.core, this.logger = typeof e.logger < "u" && typeof e.logger != "string" ? (0, import_logger.generateChildLogger)(e.logger, this.name) : (0, import_logger.pino)((0, import_logger.getDefaultLoggerOptions)({ level: e.logger || nt2 })), this.messages = new Ct2(this.logger, e.core), this.subscriber = new Tt2(this, this.logger), this.publisher = new lr(this, this.logger), this.relayUrl = (e == null ? void 0 : e.relayUrl) || le, this.projectId = e.projectId, this.provider = {};
  }
  async init() {
    ...
    if (this.transportExplicitlyClosed = false, !this.reconnecting) {
      ...
      try {
        await Promise.all([new Promise((t) => {
          ...
          await et(this.provider.connect(), 5e3, `Socket stalled when trying to connect to ${this.relayUrl}`).catch((s) => i2(s)).then(() => t()).finally(() => this.removeListener(g2.transport_closed, this.rejectTransportOpen));
  ...
  async createProvider() {
    ...
    this.provider = new JsonRpcProvider(new esm_default2(qn({ sdkVersion: ct2, protocol: this.protocol, version: this.version, relayUrl: this.relayUrl, projectId: this.projectId, auth: e, useOnCloseEvent: true }))), this.registerProviderListeners();
  }
...
var Nt = class extends p {
  constructor(e, t, i2, s = O2, n2 = void 0) {
    super(e, t, i2, s), this.core = e, this.logger = t, this.name = i2, this.map = /* @__PURE__ */ new Map(), this.version = lt2, this.cached = [], this.initialized = false, this.storagePrefix = O2, this.init = async () => {
      ...
      const h2 = zt2(zt2({}, this.getData(a2)), o);
...
var Ut2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = yt2, this.version = bt, this.events = new import_events4.default(), this.initialized = false, this.storagePrefix = O2, this.ignoredPayloadTypes = [U], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const i2 = An(), s = await this.core.crypto.setSymKey(i2), n2 = ot(import_time3.FIVE_MINUTES), a2 = { protocol: rt2 }, o = { topic: s, expiry: n2, relay: a2, active: false }, h2 = yt({ protocol: this.core.protocol, version: this.core.version, topic: s, symKey: i2, relay: a2 });
      ...
      const a2 = formatJsonRpcRequest(s, n2), o = await this.core.crypto.encode(i2, a2), h2 = F[s].req;
      return this.core.history.set(i2, a2), this.core.relayer.publish(i2, o, h2), a2.id;
    }, this.sendResult = async (i2, s, n2) => {
      const a2 = formatJsonRpcResult(i2, n2), o = await this.core.crypto.encode(s, a2), h2 = await this.core.history.get(s, i2), d2 = F[h2.request.method].res;
      await this.core.relayer.publish(s, o, d2), await this.core.history.resolve(a2);
    }, this.sendError = async (i2, s, n2) => {
      const a2 = formatJsonRpcError(i2, n2), o = await this.core.crypto.encode(s, a2), h2 = await this.core.history.get(s, i2), d2 = F[h2.request.method] ? F[h2.request.method].res : F.unregistered_method.res;
      await this.core.relayer.publish(s, o, d2), await this.core.history.resolve(a2);
    }, this.deletePairing = async (i2, s) => {
      await this.core.relayer.unsubscribe(i2), await Promise.all([this.pairings.delete(i2, w("USER_DISCONNECTED")), this.core.crypto.deleteSymKey(i2), s ? Promise.resolve() : this.core.expirer.del(i2)]);
    }, this.cleanup = async () => {
      ...
      this.registeredMethods.includes(i2) || this.logger.error(w("WC_METHOD_UNSUPPORTED", i2));
    }, this.isValidPair = (i2) => {
      if (!Dt(i2)) {
        const { message: s } = b("MISSING_OR_INVALID", `pair() params: ${i2}`);
        throw new Error(s);
      }
      if (!wt(i2.uri)) {
        const { message: s } = b("MISSING_OR_INVALID", `pair() uri: ${i2.uri}`);
        throw new Error(s);
      }
    }, this.isValidPing = async (i2) => {
      if (!Dt(i2)) {
        const { message: n2 } = b("MISSING_OR_INVALID", `ping() params: ${i2}`);
        throw new Error(n2);
      }
      const { topic: s } = i2;
      ...
      if (!Dt(i2)) {
        const { message: n2 } = b("MISSING_OR_INVALID", `disconnect() params: ${i2}`);
        throw new Error(n2);
      }
      const { topic: s } = i2;
      await this.isValidPairingTopic(s);
      ...
      if (!m(i2, false)) {
        const { message: s } = b("MISSING_OR_INVALID", `pairing topic should be a string: ${i2}`);
        throw new Error(s);
      }
      if (!this.pairings.keys.includes(i2)) {
        const { message: s } = b("NO_MATCHING_KEY", `pairing topic doesn't exist: ${i2}`);
        throw new Error(s);
      }
      if (st(this.pairings.get(i2).expiry)) {
        await this.deletePairing(i2);
        const { message: s } = b("EXPIRED", `pairing topic: ${i2}`);
        throw new Error(s);
      }
...
var Lt2 = class extends h {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.records = /* @__PURE__ */ new Map(), this.events = new import_events4.EventEmitter(), this.name = mt2, this.version = Et, this.cached = [], this.initialized = false, this.storagePrefix = O2, this.init = async () => {
      ...
      if (this.isInitialized(), this.logger.debug("Setting JSON-RPC request history record"), this.logger.trace({ type: "method", method: "set", topic: i2, request: s, chainId: n2 }), this.records.has(s.id))
        return;
      const a2 = { id: s.id, topic: i2, request: { method: s.method, params: s.params || null }, chainId: n2, expiry: ot(import_time3.THIRTY_DAYS) };
      ...
      typeof s.response > "u" && (s.response = isJsonRpcError(i2) ? { error: i2.error } : { result: i2.result }, this.records.set(s.id, s), this.events.emit(_.updated, s));
...
var Ft2 = class extends E {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.expirations = /* @__PURE__ */ new Map(), this.events = new import_events4.EventEmitter(), this.name = ft2, this.version = wt2, this.cached = [], this.initialized = false, this.storagePrefix = O2, this.init = async () => {
...
var Z2 = class _Z extends n {
  constructor(e) {
    super(e), this.protocol = ce2, this.version = Ge2, this.name = W, this.events = new import_events4.EventEmitter(), this.initialized = false, this.on = (i2, s) => this.events.on(i2, s), this.once = (i2, s) => this.events.once(i2, s), this.off = (i2, s) => this.events.off(i2, s), this.removeListener = (i2, s) => this.events.removeListener(i2, s), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || le;
    ...
    this.logger = (0, import_logger.generateChildLogger)(t, this.name), this.heartbeat = new import_heartbeat.HeartBeat(), this.crypto = new It(this, this.logger, e == null ? void 0 : e.keychain), this.history = new Lt2(this, this.logger), this.expirer = new Ft2(this, this.logger), this.storage = e != null && e.storage ? e.storage : new import_keyvaluestorage.default(kt2(kt2({}, He2), e == null ? void 0 : e.storageOptions)), this.relayer = new Ot({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new Ut2(this, this.logger), this.verify = new $t2(this.projectId || "", this.logger);
  }
  static async init(e) {
    const t = new _Z(e);
    await t.initialize();
...
var X2 = "client";
var b3 = `${j3}@${J3}:${X2}:`;
var G = { name: X2, logger: "error", controller: false, relayUrl: "wss://relay.walletconnect.com" };
var ee2 = "WALLETCONNECT_DEEPLINK_CHOICE";
var se2 = "proposal";
var te2 = "Proposal expired";
var ie2 = "session";
var C3 = import_time4.SEVEN_DAYS;
var ne3 = "engine";
...
var ce3 = (d2, n2, e) => n2 in d2 ? Ze3(d2, n2, { enumerable: true, configurable: true, writable: true, value: e }) : d2[n2] = e;
var w3 = (d2, n2) => {
  for (var e in n2 || (n2 = {}))
    ts2.call(n2, e) && ce3(d2, e, n2[e]);
  if (ae3)
    for (var e of ae3(n2))
      is2.call(n2, e) && ce3(d2, e, n2[e]);
  return d2;
};
var H3 = (d2, n2) => es2(d2, ss2(n2));
var ns2 = class extends S2 {
  constructor(n2) {
    super(n2), this.name = ne3, this.events = new import_events5.default(), this.initialized = false, this.ignoredPayloadTypes = [U], this.init = async () => {
      ...
      this.isInitialized();
      const s = H3(w3({}, e), { requiredNamespaces: e.requiredNamespaces || {}, optionalNamespaces: e.optionalNamespaces || {} });
      await this.isValidConnect(s);
      const { pairingTopic: t, requiredNamespaces: i2, optionalNamespaces: r, sessionProperties: o, relays: a2 } = s;
      let l = t, h2, I2 = false;
      if (l && (I2 = this.client.core.pairing.pairings.get(l).active), !l || !I2) {
        const { topic: v2, uri: y3 } = await this.client.core.pairing.create();
        l = v2, h2 = y3;
      }
      const g4 = await this.client.core.crypto.generateKeyPair(), E4 = w3({ requiredNamespaces: i2, optionalNamespaces: r, relays: a2 ?? [{ protocol: rt2 }], proposer: { publicKey: g4, metadata: this.client.metadata } }, o && { sessionProperties: o }), { reject: m3, resolve: V2, done: U4 } = Xn(import_time4.FIVE_MINUTES, te2);
      if (this.events.once(it("session_connect"), async ({ error: v2, session: y3 }) => {
        if (v2)
          m3(v2);
        else if (y3) {
          y3.self.publicKey = g4;
          const F2 = H3(w3({}, y3), { requiredNamespaces: y3.requiredNamespaces, optionalNamespaces: y3.optionalNamespaces });
          await this.client.session.set(y3.topic, F2), await this.setExpiry(y3.topic, y3.expiry), l && await this.client.core.pairing.updateMetadata({ topic: l, metadata: y3.peer.metadata }), V2(F2);
        }
      }), !l) {
        const { message: v2 } = b("NO_MATCHING_KEY", `connect() pairing topic: ${l}`);
        throw new Error(v2);
      }
      const A = await this.sendRequest(l, "wc_sessionPropose", E4), le2 = ot(import_time4.FIVE_MINUTES);
      return await this.setProposal(A, w3({ id: A, expiry: le2 }, E4)), { uri: h2, approval: U4 };
      ...
      const { id: s, relayProtocol: t, namespaces: i2, sessionProperties: r } = e, o = this.client.proposal.get(s);
      let { pairingTopic: a2, proposer: l, requiredNamespaces: h2, optionalNamespaces: I2 } = o;
      a2 = a2 || "", H(h2) || (h2 = St(i2, "approve()"));
      const g4 = await this.client.core.crypto.generateKeyPair(), E4 = l.publicKey, m3 = await this.client.core.crypto.generateSharedKey(g4, E4);
      a2 && s && (await this.client.core.pairing.updateMetadata({ topic: a2, metadata: l.metadata }), await this.sendResult(s, a2, { relay: { protocol: t ?? "irn" }, responderPublicKey: g4 }), await this.client.proposal.delete(s, w("USER_DISCONNECTED")), await this.client.core.pairing.activate({ topic: a2 }));
      const V2 = w3({ relay: { protocol: t ?? "irn" }, namespaces: i2, requiredNamespaces: h2, optionalNamespaces: I2, pairingTopic: a2, controller: { publicKey: g4, metadata: this.client.metadata }, expiry: ot(C3) }, r && { sessionProperties: r });
      await this.client.core.relayer.subscribe(m3), await this.sendRequest(m3, "wc_sessionSettle", V2);
      const U4 = H3(w3({}, V2), { topic: m3, pairingTopic: a2, acknowledged: false, self: V2.controller, peer: { publicKey: l.publicKey, metadata: l.metadata }, controller: g4 });
      return await this.client.session.set(m3, U4), await this.setExpiry(m3, ot(C3)), { topic: m3, acknowledged: () => new Promise((A) => setTimeout(() => A(this.client.session.get(m3)), 500)) };
    }, this.reject = async (e) => {
      this.isInitialized(), await this.isValidReject(e);
      const { id: s, reason: t } = e, { pairingTopic: i2 } = this.client.proposal.get(s);
      i2 && (await this.sendError(s, i2, t), await this.client.proposal.delete(s, w("USER_DISCONNECTED")));
    }, this.update = async (e) => {
      this.isInitialized(), await this.isValidUpdate(e);
      const { topic: s, namespaces: t } = e, i2 = await this.sendRequest(s, "wc_sessionUpdate", { namespaces: t }), { done: r, resolve: o, reject: a2 } = Xn();
      ...
      const { topic: s } = e, t = await this.sendRequest(s, "wc_sessionExtend", {}), { done: i2, resolve: r, reject: o } = Xn();
      return this.events.once(it("session_extend", t), ({ error: a2 }) => {
        a2 ? o(a2) : r();
      }), await this.setExpiry(s, ot(C3)), { acknowledged: i2 };
    }, this.request = async (e) => {
      this.isInitialized(), await this.isValidRequest(e);
      const { chainId: s, request: t, topic: i2, expiry: r } = e, o = await this.sendRequest(i2, "wc_sessionRequest", { request: t, chainId: s }, r), { done: a2, resolve: l, reject: h2 } = Xn(r);
      this.events.once(it("session_request", o), ({ error: g4, result: E4 }) => {
        g4 ? h2(g4) : l(E4);
      ...
      return ct({ id: o, topic: i2, wcDeepLink: I2 }), await a2();
      ...
      if (this.client.session.keys.includes(s)) {
        const t = await this.sendRequest(s, "wc_sessionPing", {}), { done: i2, resolve: r, reject: o } = Xn();
      ...
      if (this.client.session.keys.includes(s)) {
        ...
        let i2;
        const r = (o) => {
          (o == null ? void 0 : o.id.toString()) === t && (this.client.core.relayer.events.removeListener(g2.message_ack, r), i2());
        };
        await Promise.all([new Promise((o) => {
          i2 = o, this.client.core.relayer.on(g2.message_ack, r);
    ...
    }, this.find = (e) => (this.isInitialized(), this.client.session.getAll().filter((s) => Rt(s, e))), this.getPendingSessionRequests = () => (this.isInitialized(), this.client.pendingRequest.getAll()), this.cleanupDuplicatePairings = async (e) => {
      if (e.pairingTopic)
        try {
          const s = this.client.core.pairing.pairings.get(e.pairingTopic), t = this.client.core.pairing.pairings.getAll().filter((i2) => {
            var r, o;
            return ((r = i2.peerMetadata) == null ? void 0 : r.url) && ((o = i2.peerMetadata) == null ? void 0 : o.url) === e.peer.metadata.url && i2.topic && i2.topic !== s.topic;
          });
          if (t.length === 0)
            return;
      ...
      const s = O3.wc_sessionRequest.req.ttl, { id: t, topic: i2, params: r } = e;
      await this.client.pendingRequest.set(t, { id: t, topic: i2, params: r }), s && this.client.core.expirer.set(t, ot(s));
    }, this.sendRequest = async (e, s, t, i2, r) => {
      const o = formatJsonRpcRequest(s, t);
      if (je() && oe3.includes(s)) {
      ...
      return i2 && (l.ttl = i2), r && (l.id = r), this.client.core.history.set(e, o), this.client.core.relayer.publish(e, a2, l), o.id;
    }, this.sendResult = async (e, s, t) => {
      const i2 = formatJsonRpcResult(e, t), r = await this.client.core.crypto.encode(s, i2), o = await this.client.core.history.get(s, e), a2 = O3[o.request.method].res;
      this.client.core.relayer.publish(s, r, a2), await this.client.core.history.resolve(i2);
    }, this.sendError = async (e, s, t) => {
      const i2 = formatJsonRpcError(e, t), r = await this.client.core.crypto.encode(s, i2), o = await this.client.core.history.get(s, e), a2 = O3[o.request.method].res;
      this.client.core.relayer.publish(s, r, a2), await this.client.core.history.resolve(i2);
    }, this.cleanup = async () => {
      const e = [], s = [];
      ...
      const { topic: s } = e, { message: t } = b("MISSING_OR_INVALID", `Decoded payload on topic ${s} is not identifiable as a JSON-RPC request or a response.`);
      throw new Error(t);
    }, this.onSessionProposeRequest = async (e, s) => {
      const { params: t, id: i2 } = s;
      try {
        this.isValidConnect(w3({}, s.params));
        const r = ot(import_time4.FIVE_MINUTES), o = w3({ id: i2, pairingTopic: e, expiry: r }, t);
        ...
        await this.sendError(i2, e, r), this.client.logger.error(r);
      }
      ...
      if (isJsonRpcResult(s)) {
        ...
        isJsonRpcError(s) && (await this.client.proposal.delete(t, w("USER_DISCONNECTED")), this.events.emit(it("session_connect"), { error: s.error }));
    }, this.onSessionSettleRequest = async (e, s) => {
      const { id: t, params: i2 } = s;
      try {
        this.isValidSessionSettleRequest(i2);
        const { relay: r, controller: o, expiry: a2, namespaces: l, requiredNamespaces: h2, optionalNamespaces: I2, sessionProperties: g4, pairingTopic: E4 } = s.params, m3 = w3({ topic: e, relay: r, expiry: a2, namespaces: l, acknowledged: true, pairingTopic: E4, requiredNamespaces: h2, optionalNamespaces: I2, controller: o.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: o.publicKey, metadata: o.metadata } }, g4 && { sessionProperties: g4 });
      ...
      const { id: t } = s;
      isJsonRpcResult(s) ? (await this.client.session.update(e, { acknowledged: true }), this.events.emit(it("session_approve", t), {})) : isJsonRpcError(s) && (await this.client.session.delete(e, w("USER_DISCONNECTED")), this.events.emit(it("session_approve", t), { error: s.error }));
    }, this.onSessionUpdateRequest = async (e, s) => {
      const { params: t, id: i2 } = s;
      try {
        this.isValidUpdate(w3({ topic: e }, t)), await this.client.session.update(e, { namespaces: t.namespaces }), await this.sendResult(i2, e, true), this.client.events.emit("session_update", { id: i2, topic: e, params: t });
      } catch (r) {
        await this.sendError(i2, e, r), this.client.logger.error(r);
      }
      ...
      const { id: t } = s;
      try {
        this.isValidExtend({ topic: e }), await this.setExpiry(e, ot(C3)), await this.sendResult(t, e, true), this.client.events.emit("session_extend", { id: t, topic: e });
      } catch (i2) {
      ...
      const { id: t, params: i2 } = s;
      try {
        this.isValidRequest(w3({ topic: e }, i2)), await this.setPendingSessionRequest({ id: t, topic: e, params: i2 });
        const r = $n(JSON.stringify(s)), o = this.client.session.get(e), a2 = await this.getVerifyContext(r, o.peer.metadata);
        this.client.events.emit("session_request", { id: t, topic: e, params: i2, verifyContext: a2 });
      } catch (r) {
        await this.sendError(t, e, r), this.client.logger.error(r);
      }
      ...
      const { id: t, params: i2 } = s;
      try {
        this.isValidEmit(w3({ topic: e }, i2)), this.client.events.emit("session_event", { id: t, topic: e, params: i2 });
      } catch (r) {
        await this.sendError(t, e, r), this.client.logger.error(r);
      }
      ...
      const { pairingTopic: s, requiredNamespaces: t, optionalNamespaces: i2, sessionProperties: r, relays: o } = e;
      if (I(s) || await this.isValidPairingTopic(s), !jt(o, true)) {
        const { message: a2 } = b("MISSING_OR_INVALID", `connect() relays: ${o}`);
        throw new Error(a2);
      }
      !I(t) && H(t) !== 0 && this.validateNamespaces(t, "requiredNamespaces"), !I(i2) && H(i2) !== 0 && this.validateNamespaces(i2, "optionalNamespaces"), I(r) || this.validateSessionProps(r, "sessionProperties");
      ...
      const { id: s, namespaces: t, relayProtocol: i2, sessionProperties: r } = e;
      ...
      if (!m(i2, true)) {
        const { message: h2 } = b("MISSING_OR_INVALID", `approve() relayProtocol: ${i2}`);
        throw new Error(h2);
      }
      I(r) || this.validateSessionProps(r, "sessionProperties");
    }, this.isValidReject = async (e) => {
      if (!Dt(e)) {
        const { message: i2 } = b("MISSING_OR_INVALID", `reject() params: ${e}`);
        throw new Error(i2);
      }
      const { id: s, reason: t } = e;
      if (await this.isValidProposalId(s), !Vt(t)) {
        const { message: i2 } = b("MISSING_OR_INVALID", `reject() reason: ${JSON.stringify(t)}`);
        throw new Error(i2);
      }
    }, this.isValidSessionSettleRequest = (e) => {
      if (!Dt(e)) {
        const { message: l } = b("MISSING_OR_INVALID", `onSessionSettleRequest() params: ${e}`);
        throw new Error(l);
      }
      const { relay: s, controller: t, namespaces: i2, expiry: r } = e;
      if (!cn(s)) {
        const { message: l } = b("MISSING_OR_INVALID", "onSessionSettleRequest() relay protocol should be a string");
        throw new Error(l);
      }
      ...
      if (a2)
        throw new Error(a2.message);
      if (st(r)) {
        const { message: l } = b("EXPIRED", "onSessionSettleRequest()");
        throw new Error(l);
      }
      ...
      const i2 = this.client.session.get(s), r = sn(t, "update()");
      if (r)
      ...
      const { topic: s, request: t, chainId: i2, expiry: r } = e;
      await this.isValidSessionTopic(s);
      const { namespaces: o } = this.client.session.get(s);
      if (!Lt(o, i2)) {
        const { message: a2 } = b("MISSING_OR_INVALID", `request() chainId: ${i2}`);
        throw new Error(a2);
      }
      if (!Mt(t)) {
      ...
      if (r && !zt(r, $2)) {
        const { message: a2 } = b("MISSING_OR_INVALID", `request() expiry: ${r}. Expiry must be a number (in seconds) between ${$2.min} and ${$2.max}`);
        throw new Error(a2);
      }
    }, this.isValidRespond = async (e) => {
      if (!Dt(e)) {
        const { message: i2 } = b("MISSING_OR_INVALID", `respond() params: ${e}`);
        throw new Error(i2);
      }
      const { topic: s, response: t } = e;
      if (await this.isValidSessionTopic(s), !kt(t)) {
        const { message: i2 } = b("MISSING_OR_INVALID", `respond() response: ${JSON.stringify(t)}`);
        throw new Error(i2);
      }
      ...
      if (!Lt(r, i2)) {
        const { message: o } = b("MISSING_OR_INVALID", `emit() chainId: ${i2}`);
        throw new Error(o);
      }
      if (!Kt(t)) {
      ...
      Object.values(e).forEach((t) => {
        if (!m(t, false)) {
          const { message: i2 } = b("MISSING_OR_INVALID", `${s} must be in Record<string, string> format. Received: ${JSON.stringify(t)}`);
          throw new Error(i2);
        }
      });
    };
  ...
  isInitialized() {
    if (!this.initialized) {
      const { message: n2 } = b("NOT_INITIALIZED", this.name);
      throw new Error(n2);
    }
  }
  registerRelayerEvents() {
  ...
  registerExpirerEvents() {
    this.client.core.expirer.on(w2.expired, async (n2) => {
      const { topic: e, id: s } = rt(n2.target);
      if (s && this.client.pendingRequest.keys.includes(s))
        return await this.deletePendingSessionRequest(s, b("EXPIRED"), true);
  ...
  isValidPairingTopic(n2) {
    if (!m(n2, false)) {
      const { message: e } = b("MISSING_OR_INVALID", `pairing topic should be a string: ${n2}`);
      throw new Error(e);
    }
    if (!this.client.core.pairing.pairings.keys.includes(n2)) {
      const { message: e } = b("NO_MATCHING_KEY", `pairing topic doesn't exist: ${n2}`);
      throw new Error(e);
    }
    if (st(this.client.core.pairing.pairings.get(n2).expiry)) {
      const { message: e } = b("EXPIRED", `pairing topic: ${n2}`);
      throw new Error(e);
    }
  }
  async isValidSessionTopic(n2) {
    if (!m(n2, false)) {
      const { message: e } = b("MISSING_OR_INVALID", `session topic should be a string: ${n2}`);
      throw new Error(e);
    }
    if (!this.client.session.keys.includes(n2)) {
      const { message: e } = b("NO_MATCHING_KEY", `session topic doesn't exist: ${n2}`);
      throw new Error(e);
    }
    if (st(this.client.session.get(n2).expiry)) {
      await this.deleteSession(n2);
      const { message: e } = b("EXPIRED", `session topic: ${n2}`);
      throw new Error(e);
    }
  }
  async isValidSessionOrPairingTopic(n2) {
    if (this.client.session.keys.includes(n2))
      ...
      const { message: e } = b("NO_MATCHING_KEY", `session or pairing topic doesn't exist: ${n2}`);
      throw new Error(e);
    } else {
      const { message: e } = b("MISSING_OR_INVALID", `session or pairing topic should be a string: ${n2}`);
      throw new Error(e);
    }
  }
  async isValidProposalId(n2) {
    if (!Ct(n2)) {
      const { message: e } = b("MISSING_OR_INVALID", `proposal id should be a number: ${n2}`);
      throw new Error(e);
    }
    if (!this.client.proposal.keys.includes(n2)) {
      const { message: e } = b("NO_MATCHING_KEY", `proposal id doesn't exist: ${n2}`);
      throw new Error(e);
    }
    if (st(this.client.proposal.get(n2).expiry)) {
      await this.deleteProposal(n2);
      const { message: e } = b("EXPIRED", `proposal id: ${n2}`);
      throw new Error(e);
    }
  }
};
var rs2 = class extends Nt {
  constructor(n2, e) {
    super(n2, e, se2, b3), this.core = n2, this.logger = e;
  }
};
var os2 = class extends Nt {
  constructor(n2, e) {
    super(n2, e, ie2, b3), this.core = n2, this.logger = e;
  }
};
var as2 = class extends Nt {
  constructor(n2, e) {
    super(n2, e, re, b3, (s) => s.id), this.core = n2, this.logger = e;
  }
};
var M2 = class _M extends b2 {
  constructor(n2) {
    super(n2), this.protocol = j3, this.version = J3, this.name = G.name, this.events = new import_events5.EventEmitter(), this.on = (s, t) => this.events.on(s, t), this.once = (s, t) => this.events.once(s, t), this.off = (s, t) => this.events.off(s, t), this.removeListener = (s, t) => this.events.removeListener(s, t), this.removeAllListeners = (s) => this.events.removeAllListeners(s), this.connect = async (s) => {
      try {
    ...
    }, this.name = (n2 == null ? void 0 : n2.name) || G.name, this.metadata = (n2 == null ? void 0 : n2.metadata) || Fn();
    const e = typeof (n2 == null ? void 0 : n2.logger) < "u" && typeof (n2 == null ? void 0 : n2.logger) != "string" ? n2.logger : (0, import_logger2.pino)((0, import_logger2.getDefaultLoggerOptions)({ level: (n2 == null ? void 0 : n2.logger) || G.logger }));
    this.core = (n2 == null ? void 0 : n2.core) || new Sr(n2), this.logger = (0, import_logger2.generateChildLogger)(e, this.name), this.session = new os2(this.core, this.logger), this.proposal = new rs2(this.core, this.logger), this.pendingRequest = new as2(this.core, this.logger), this.engine = new ns2(this);
  }
...
var pe3 = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
var $i2 = { exports: {} };
(function(C4, u4) {
  (function() {
    var i2, p4 = "4.17.21", I2 = 200, D3 = "Unsupported core-js use. Try https://npms.io/search?q=ponyfill.", F2 = "Expected a function", Fn2 = "Invalid `variable` option passed into `_.template`", Gt = "__lodash_hash_undefined__", lr2 = 500, At3 = "__lodash_placeholder__", Ln = 1, Mn2 = 2, Ct3 = 4, It2 = 1, de3 = 2, vn2 = 1, ft3 = 2, Mi2 = 4, Dn2 = 8, xt3 = 16, Nn = 32, Et2 = 64, qn2 = 128, zt3 = 256, pr2 = 512, Ta = 30, La = "...", Da = 800, Na = 16, qi2 = 1, Ha = 2, $a = 3, ct3 = 1 / 0, kn2 = 9007199254740991, Ua = 17976931348623157e292, ge3 = 0 / 0, Hn = 4294967295, Wa = Hn - 1, Fa = Hn >>> 1, Ma = [["ary", qn2], ["bind", vn2], ["bindKey", ft3], ["curry", Dn2], ["curryRight", xt3], ["flip", pr2], ["partial", Nn], ["partialRight", Et2], ["rearg", zt3]], yt3 = "[object Arguments]", ve2 = "[object Array]", qa = "[object AsyncFunction]", Kt3 = "[object Boolean]", Yt = "[object Date]", Ba = "[object DOMException]", _e2 = "[object Error]", me2 = "[object Function]", Bi2 = "[object GeneratorFunction]", yn = "[object Map]", Zt = "[object Number]", Ga = "[object Null]", Bn2 = "[object Object]", Gi2 = "[object Promise]", za = "[object Proxy]", Jt = "[object RegExp]", Sn = "[object Set]", Xt = "[object String]", we3 = "[object Symbol]", Ka = "[object Undefined]", Qt = "[object WeakMap]", Ya = "[object WeakSet]", Vt3 = "[object ArrayBuffer]", St3 = "[object DataView]", dr2 = "[object Float32Array]", gr2 = "[object Float64Array]", vr2 = "[object Int8Array]", _r2 = "[object Int16Array]", mr2 = "[object Int32Array]", wr2 = "[object Uint8Array]", Pr = "[object Uint8ClampedArray]", Ar = "[object Uint16Array]", Cr2 = "[object Uint32Array]", Za = /\b__p \+= '';/g, Ja = /\b(__p \+=) '' \+/g, Xa = /(__e\(.*?\)|\b__t\)) \+\n'';/g, zi = /&(?:amp|lt|gt|quot|#39);/g, Ki2 = /[&<>"']/g, Qa = RegExp(zi.source), Va = RegExp(Ki2.source), ka = /<%-([\s\S]+?)%>/g, ja = /<%([\s\S]+?)%>/g, Yi2 = /<%=([\s\S]+?)%>/g, no = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, to = /^\w*$/, eo = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Ir2 = /[\\^$.*+?()[\]{}|]/g, ro = RegExp(Ir2.source), xr = /^\s+/, io = /\s/, so = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, uo = /\{\n\/\* \[wrapped with (.+)\] \*/, ao = /,? & /, oo = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, fo = /[()=,{}\[\]\/\s]/, co = /\\(\\)?/g, ho = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, Zi2 = /\w*$/, lo = /^[-+]0x[0-9a-f]+$/i, po = /^0b[01]+$/i, go = /^\[object .+?Constructor\]$/, vo = /^0o[0-7]+$/i, _o = /^(?:0|[1-9]\d*)$/, mo = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, Pe2 = /($^)/, wo = /['\n\r\u2028\u2029\\]/g, Ae3 = "\\ud800-\\udfff", Po = "\\u0300-\\u036f", Ao = "\\ufe20-\\ufe2f", Co = "\\u20d0-\\u20ff", Ji2 = Po + Ao + Co, Xi2 = "\\u2700-\\u27bf", Qi2 = "a-z\\xdf-\\xf6\\xf8-\\xff", Io = "\\xac\\xb1\\xd7\\xf7", xo = "\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf", Eo = "\\u2000-\\u206f", yo = " \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", Vi2 = "A-Z\\xc0-\\xd6\\xd8-\\xde", ki2 = "\\ufe0e\\ufe0f", ji2 = Io + xo + Eo + yo, Er2 = "['’]", So = "[" + Ae3 + "]", ns3 = "[" + ji2 + "]", Ce3 = "[" + Ji2 + "]", ts3 = "\\d+", Oo = "[" + Xi2 + "]", es3 = "[" + Qi2 + "]", rs3 = "[^" + Ae3 + ji2 + ts3 + Xi2 + Qi2 + Vi2 + "]", yr2 = "\\ud83c[\\udffb-\\udfff]", Ro = "(?:" + Ce3 + "|" + yr2 + ")", is3 = "[^" + Ae3 + "]", Sr2 = "(?:\\ud83c[\\udde6-\\uddff]){2}", Or = "[\\ud800-\\udbff][\\udc00-\\udfff]", Ot2 = "[" + Vi2 + "]", ss3 = "\\u200d", us2 = "(?:" + es3 + "|" + rs3 + ")", bo = "(?:" + Ot2 + "|" + rs3 + ")", as3 = "(?:" + Er2 + "(?:d|ll|m|re|s|t|ve))?", os3 = "(?:" + Er2 + "(?:D|LL|M|RE|S|T|VE))?", fs2 = Ro + "?", cs2 = "[" + ki2 + "]?", To = "(?:" + ss3 + "(?:" + [is3, Sr2, Or].join("|") + ")" + cs2 + fs2 + ")*", Lo = "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Do = "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", hs2 = cs2 + fs2 + To, No = "(?:" + [Oo, Sr2, Or].join("|") + ")" + hs2, Ho = "(?:" + [is3 + Ce3 + "?", Ce3, Sr2, Or, So].join("|") + ")", $o = RegExp(Er2, "g"), Uo = RegExp(Ce3, "g"), Rr2 = RegExp(yr2 + "(?=" + yr2 + ")|" + Ho + hs2, "g"), Wo = RegExp([Ot2 + "?" + es3 + "+" + as3 + "(?=" + [ns3, Ot2, "$"].join("|") + ")", bo + "+" + os3 + "(?=" + [ns3, Ot2 + us2, "$"].join("|") + ")", Ot2 + "?" + us2 + "+" + as3, Ot2 + "+" + os3, Do, Lo, ts3, No].join("|"), "g"), Fo = RegExp("[" + ss3 + Ae3 + Ji2 + ki2 + "]"), Mo = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, qo = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], Bo = -1, B2 = {};
    ...
    function cn2(h2, g4, d2) {
      switch (d2.length) {
        case 0:
          return h2.call(g4);
        case 1:
          return h2.call(g4, d2[0]);
        case 2:
          return h2.call(g4, d2[0], d2[1]);
        case 3:
          return h2.call(g4, d2[0], d2[1], d2[2]);
      }
      return h2.apply(g4, d2);
    }
    function Qo(h2, g4, d2, P2) {
      for (var S4 = -1, $4 = h2 == null ? 0 : h2.length; ++S4 < $4; ) {
        var X3 = h2[S4];
        g4(P2, X3, d2(X3), h2);
      }
      return P2;
    ...
    function mn2(h2, g4) {
      for (var d2 = -1, P2 = h2 == null ? 0 : h2.length; ++d2 < P2 && g4(h2[d2], d2, h2) !== false; )
        ;
      return h2;
    }
    function Vo(h2, g4) {
      for (var d2 = h2 == null ? 0 : h2.length; d2-- && g4(h2[d2], d2, h2) !== false; )
        ;
      return h2;
    }
    function Ps2(h2, g4) {
    ...
    function jn2(h2, g4) {
      for (var d2 = -1, P2 = h2 == null ? 0 : h2.length, S4 = 0, $4 = []; ++d2 < P2; ) {
        var X3 = h2[d2];
        g4(X3, d2, h2) && ($4[S4++] = X3);
      }
      return $4;
    ...
    function Ie3(h2, g4) {
      ...
      return !!d2 && Rt3(h2, g4, 0) > -1;
    }
    function Lr(h2, g4, d2) {
      for (var P2 = -1, S4 = h2 == null ? 0 : h2.length; ++P2 < S4; )
        if (d2(g4, h2[P2]))
          return true;
      return false;
    }
    function G3(h2, g4) {
      for (var d2 = -1, P2 = h2 == null ? 0 : h2.length, S4 = Array(P2); ++d2 < P2; )
        S4[d2] = g4(h2[d2], d2, h2);
      return S4;
    }
    function nt3(h2, g4) {
      for (var d2 = -1, P2 = g4.length, S4 = h2.length; ++d2 < P2; )
        h2[S4 + d2] = g4[d2];
      return h2;
    }
    function Dr2(h2, g4, d2, P2) {
      var S4 = -1, $4 = h2 == null ? 0 : h2.length;
      for (P2 && $4 && (d2 = h2[++S4]); ++S4 < $4; )
        d2 = g4(d2, h2[S4], S4, h2);
      return d2;
    }
    function ko(h2, g4, d2, P2) {
      var S4 = h2 == null ? 0 : h2.length;
      for (P2 && S4 && (d2 = h2[--S4]); S4--; )
        d2 = g4(d2, h2[S4], S4, h2);
      return d2;
    }
    function Nr(h2, g4) {
    ...
    function As2(h2, g4, d2) {
      var P2;
      return d2(h2, function(S4, $4, X3) {
        if (g4(S4, $4, X3))
          return P2 = $4, false;
      }), P2;
    }
    function xe3(h2, g4, d2, P2) {
      for (var S4 = h2.length, $4 = d2 + (P2 ? 1 : -1); P2 ? $4-- : ++$4 < S4; )
        if (g4(h2[$4], $4, h2))
          return $4;
      return -1;
    }
    function Rt3(h2, g4, d2) {
      return g4 === g4 ? df(h2, g4, d2) : xe3(h2, Cs2, d2);
    }
    function ef(h2, g4, d2, P2) {
      for (var S4 = d2 - 1, $4 = h2.length; ++S4 < $4; )
        if (P2(h2[S4], g4))
          return S4;
      return -1;
    }
    ...
    function Is2(h2, g4) {
      var d2 = h2 == null ? 0 : h2.length;
      return d2 ? Ur(h2, g4) / d2 : ge3;
    }
    function Hr(h2) {
      return function(g4) {
        return g4 == null ? i2 : g4[h2];
      };
    }
    function $r(h2) {
      return function(g4) {
        return h2 == null ? i2 : h2[g4];
      };
    }
    function xs2(h2, g4, d2, P2, S4) {
      return S4(h2, function($4, X3, M4) {
        d2 = P2 ? (P2 = false, $4) : g4(d2, $4, X3, M4);
      }), d2;
    }
    function rf(h2, g4) {
      var d2 = h2.length;
    ...
    function Ur(h2, g4) {
      for (var d2, P2 = -1, S4 = h2.length; ++P2 < S4; ) {
        var $4 = g4(h2[P2]);
        $4 !== i2 && (d2 = d2 === i2 ? $4 : d2 + $4);
      }
      return d2;
    }
    function Wr(h2, g4) {
    ...
    function ys2(h2, g4) {
      for (var d2 = -1, P2 = h2.length; ++d2 < P2 && Rt3(g4, h2[d2], 0) > -1; )
        ;
      return d2;
    }
    function Ss2(h2, g4) {
      for (var d2 = h2.length; d2-- && Rt3(g4, h2[d2], 0) > -1; )
        ;
      return d2;
    }
    function uf(h2, g4) {
    ...
    function lf(h2) {
      for (var g4, d2 = []; !(g4 = h2.next()).done; )
        d2.push(g4.value);
      return d2;
    }
    function Mr(h2) {
      var g4 = -1, d2 = Array(h2.size);
      return h2.forEach(function(P2, S4) {
        d2[++g4] = [S4, P2];
      }), d2;
    }
    function Os2(h2, g4) {
    ...
    function tt3(h2, g4) {
      for (var d2 = -1, P2 = h2.length, S4 = 0, $4 = []; ++d2 < P2; ) {
        var X3 = h2[d2];
        (X3 === g4 || X3 === At3) && (h2[d2] = At3, $4[S4++] = d2);
      }
      return $4;
    }
    function Ee(h2) {
    ...
    function df(h2, g4, d2) {
      for (var P2 = d2 - 1, S4 = h2.length; ++P2 < S4; )
        if (h2[P2] === g4)
          return P2;
      return -1;
    }
    function gf(h2, g4, d2) {
      for (var P2 = d2 + 1; P2--; )
        if (h2[P2] === g4)
          return P2;
      return P2;
    ...
    function Rs2(h2) {
      for (var g4 = h2.length; g4-- && io.test(h2.charAt(g4)); )
        ;
      return g4;
    }
    var vf = $r(Ko);
    function _f(h2) {
      for (var g4 = Rr2.lastIndex = 0; Rr2.test(h2); )
        ++g4;
      return g4;
    }
    function mf(h2) {
    ...
    var Pf = function h2(g4) {
      g4 = g4 == null ? k2 : Lt3.defaults(k2.Object(), g4, Lt3.pick(k2, qo));
      var d2 = g4.Array, P2 = g4.Date, S4 = g4.Error, $4 = g4.Function, X3 = g4.Math, M4 = g4.Object, qr = g4.RegExp, Af = g4.String, wn2 = g4.TypeError, ye2 = d2.prototype, Cf = $4.prototype, Dt3 = M4.prototype, Se2 = g4["__core-js_shared__"], Oe3 = Cf.toString, W2 = Dt3.hasOwnProperty, If = 0, bs2 = function() {
        var n2 = /[^.]+$/.exec(Se2 && Se2.keys && Se2.keys.IE_PROTO || "");
        return n2 ? "Symbol(src)_1." + n2 : "";
      }(), Re2 = Dt3.toString, xf = Oe3.call(M4), Ef = k2._, yf = qr("^" + Oe3.call(W2).replace(Ir2, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), be = ps2 ? g4.Buffer : i2, et3 = g4.Symbol, Te2 = g4.Uint8Array, Ts2 = be ? be.allocUnsafe : i2, Le2 = Os2(M4.getPrototypeOf, M4), Ls2 = M4.create, Ds2 = Dt3.propertyIsEnumerable, De3 = ye2.splice, Ns2 = et3 ? et3.isConcatSpreadable : i2, jt3 = et3 ? et3.iterator : i2, lt3 = et3 ? et3.toStringTag : i2, Ne2 = function() {
        try {
          var n2 = _t3(M4, "defineProperty");
          return n2({}, "", {}), n2;
        } catch {
        }
      }(), Sf = g4.clearTimeout !== k2.clearTimeout && g4.clearTimeout, Of = P2 && P2.now !== k2.Date.now && P2.now, Rf = g4.setTimeout !== k2.setTimeout && g4.setTimeout, He3 = X3.ceil, $e4 = X3.floor, Br = M4.getOwnPropertySymbols, bf = be ? be.isBuffer : i2, Hs2 = g4.isFinite, Tf = ye2.join, Lf = Os2(M4.keys, M4), Q4 = X3.max, nn2 = X3.min, Df = P2.now, Nf = g4.parseInt, $s2 = X3.random, Hf = ye2.reverse, Gr = _t3(g4, "DataView"), ne4 = _t3(g4, "Map"), zr = _t3(g4, "Promise"), Nt2 = _t3(g4, "Set"), te3 = _t3(g4, "WeakMap"), ee3 = _t3(M4, "create"), Ue3 = te3 && new te3(), Ht2 = {}, $f = mt3(Gr), Uf = mt3(ne4), Wf = mt3(zr), Ff = mt3(Nt2), Mf = mt3(te3), We2 = et3 ? et3.prototype : i2, re2 = We2 ? We2.valueOf : i2, Us2 = We2 ? We2.toString : i2;
      function a2(n2) {
        if (K2(n2) && !O5(n2) && !(n2 instanceof N12)) {
          if (n2 instanceof Pn)
            return n2;
      ...
      function Gf() {
        var n2 = this.__wrapped__.value(), t = this.__dir__, e = O5(n2), r = t < 0, s = e ? n2.length : 0, o = th(0, s, this.__views__), f4 = o.start, c2 = o.end, l = c2 - f4, v2 = r ? c2 : f4 - 1, _3 = this.__iteratees__, m3 = _3.length, w4 = 0, A = nn2(l, this.__takeCount__);
        if (!e || !r && s == l && A == l)
        ...
        n:
          for (; l-- && w4 < A; ) {
            v2 += t;
            for (var b5 = -1, y3 = n2[v2]; ++b5 < m3; ) {
              var L4 = _3[b5], H4 = L4.iteratee, dn = L4.type, sn2 = H4(y3);
              if (dn == Ha)
                y3 = sn2;
              else if (!sn2) {
                if (dn == qi2)
      ...
      N12.prototype = $t3(Fe3.prototype), N12.prototype.constructor = N12;
      function pt3(n2) {
      ...
      function Jf(n2, t) {
        var e = this.__data__;
        return this.size += this.has(n2) ? 0 : 1, e[n2] = ee3 && t === i2 ? Gt : t, this;
      }
      ...
      function Ws2(n2, t) {
        var e = O5(n2), r = !e && wt3(n2), s = !e && !r && at3(n2), o = !e && !r && !s && Mt3(n2), f4 = e || r || s || o, c2 = f4 ? Wr(n2.length, Af) : [], l = c2.length;
        for (var v2 in n2)
          (t || W2.call(n2, v2)) && !(f4 && (v2 == "length" || s && (v2 == "offset" || v2 == "parent") || o && (v2 == "buffer" || v2 == "byteLength" || v2 == "byteOffset") || Jn(v2, l))) && c2.push(v2);
        return c2;
      }
      function Fs2(n2) {
        var t = n2.length;
      ...
      function An2(n2, t, e, r, s, o) {
        var f4, c2 = t & Ln, l = t & Mn2, v2 = t & Ct3;
        if (e && (f4 = s ? e(n2, r, s, o) : e(n2)), f4 !== i2)
          return f4;
        if (!z3(n2))
          return n2;
        var _3 = O5(n2);
        if (_3) {
          ...
          var m3 = tn2(n2), w4 = m3 == me2 || m3 == Bi2;
          if (at3(n2))
            return cu(n2, c2);
          if (m3 == Bn2 || m3 == yt3 || w4 && !s) {
            if (f4 = l || w4 ? {} : Ru(n2), !c2)
              return l ? Yc(n2, gc(f4, n2)) : Kc(n2, Ms2(f4, n2));
          } else {
            if (!q4[m3])
              return s ? n2 : {};
            f4 = ih(n2, m3, c2);
        ...
        if (A)
          return A;
        o.set(n2, f4), ia(n2) ? n2.forEach(function(y3) {
          f4.add(An2(y3, t, e, y3, n2, o));
        }) : ea(n2) && n2.forEach(function(y3, L4) {
          f4.set(L4, An2(y3, t, e, L4, n2, o));
        });
        var E4 = v2 ? l ? li : hi : l ? on2 : V2, b5 = _3 ? i2 : E4(n2);
        return mn2(b5 || n2, function(y3, L4) {
          b5 && (L4 = y3, y3 = n2[L4]), ie3(f4, L4, An2(y3, t, e, L4, n2, o));
        }), f4;
      }
      function vc(n2) {
        var t = V2(n2);
      ...
      function qs2(n2, t, e) {
        ...
        if (n2 == null)
          return !r;
        for (n2 = M4(n2); r--; ) {
          var s = e[r], o = t[s], f4 = n2[s];
          if (f4 === i2 && !(s in n2) || !o(f4))
            return false;
        }
        return true;
      }
      ...
      function se3(n2, t, e, r) {
        var s = -1, o = Ie3, f4 = true, c2 = n2.length, l = [], v2 = t.length;
        if (!c2)
          return l;
        e && (t = G3(t, hn2(e))), r ? (o = Lr, f4 = false) : t.length >= I2 && (o = kt3, f4 = false, t = new dt3(t));
        n:
          for (; ++s < c2; ) {
            var _3 = n2[s], m3 = e == null ? _3 : e(_3);
            if (_3 = r || _3 !== 0 ? _3 : 0, f4 && m3 === m3) {
              for (var w4 = v2; w4--; )
                if (t[w4] === m3)
                  continue n;
              l.push(_3);
      ...
      function qe3(n2, t, e) {
        for (var r = -1, s = n2.length; ++r < s; ) {
          var o = n2[r], f4 = t(o);
          if (f4 != null && (c2 === i2 ? f4 === f4 && !pn2(f4) : e(f4, c2)))
            var c2 = f4, l = o;
        }
        return l;
      }
      ...
      function en2(n2) {
        return n2 == null ? n2 === i2 ? Ka : Ga : lt3 && lt3 in M4(n2) ? nh(n2) : ph(n2);
      }
      function Xr(n2, t) {
        return n2 > t;
      }
      ...
      function Qr(n2, t, e) {
        for (var r = e ? Lr : Ie3, s = n2[0].length, o = n2.length, f4 = o, c2 = d2(o), l = 1 / 0, v2 = []; f4--; ) {
          var _3 = n2[f4];
          f4 && t && (_3 = G3(_3, hn2(t))), l = nn2(_3.length, l), c2[f4] = !e && (t || s >= 120 && _3.length >= 120) ? new dt3(f4 && _3) : i2;
        }
        _3 = n2[0];
        var m3 = -1, w4 = c2[0];
        n:
          for (; ++m3 < s && v2.length < l; ) {
            var A = _3[m3], E4 = t ? t(A) : A;
            if (A = e || A !== 0 ? A : 0, !(w4 ? kt3(w4, E4) : r(v2, E4, e))) {
              for (f4 = o; --f4; ) {
                var b5 = c2[f4];
                if (!(b5 ? kt3(b5, E4) : r(n2[f4], E4, e)))
                  continue n;
              }
              w4 && w4.push(E4), v2.push(A);
            }
          }
        return v2;
      }
      function Cc(n2, t, e, r) {
        return $n2(n2, function(s, o, f4) {
          t(r, e(s), o, f4);
        }), r;
      }
      function ue4(n2, t, e) {
      ...
      function xc(n2) {
        return K2(n2) && en2(n2) == Yt;
      }
      function ae4(n2, t, e, r, s) {
        return n2 === t ? true : n2 == null || t == null || !K2(n2) && !K2(t) ? n2 !== n2 && t !== t : Ec(n2, t, e, r, ae4, s);
      }
      function Ec(n2, t, e, r, s, o) {
        var f4 = O5(n2), c2 = O5(t), l = f4 ? ve2 : tn2(n2), v2 = c2 ? ve2 : tn2(t);
        l = l == yt3 ? Bn2 : l, v2 = v2 == yt3 ? Bn2 : v2;
        var _3 = l == Bn2, m3 = v2 == Bn2, w4 = l == v2;
        if (w4 && at3(n2)) {
          if (!at3(t))
            return false;
          f4 = true, _3 = false;
        ...
        if (w4 && !_3)
          return o || (o = new Rn2()), f4 || Mt3(n2) ? yu(n2, t, e, r, s, o) : kc(n2, t, l, e, r, s, o);
        if (!(e & It2)) {
          var A = _3 && W2.call(n2, "__wrapped__"), E4 = m3 && W2.call(t, "__wrapped__");
          if (A || E4) {
            var b5 = A ? n2.value() : n2, y3 = E4 ? t.value() : t;
            return o || (o = new Rn2()), s(b5, y3, e, r, o);
          }
        }
        return w4 ? (o || (o = new Rn2()), jc(n2, t, e, r, s, o)) : false;
      }
      function yc(n2) {
        return K2(n2) && tn2(n2) == yn;
      }
      function Vr(n2, t, e, r) {
        var s = e.length, o = s, f4 = !r;
        if (n2 == null)
          return !o;
        for (n2 = M4(n2); s--; ) {
          var c2 = e[s];
        ...
        for (; ++s < o; ) {
          ...
          if (f4 && c2[2]) {
            ...
            var m3 = new Rn2();
            if (r)
              var w4 = r(v2, _3, l, n2, t, m3);
            if (!(w4 === i2 ? ae4(_3, v2, It2 | de3, r, m3) : w4))
              return false;
          }
        }
        return true;
      ...
      function Sc(n2) {
        return K2(n2) && en2(n2) == Jt;
      }
      function Oc(n2) {
        return K2(n2) && tn2(n2) == Sn;
      }
      function Rc(n2) {
        return K2(n2) && sr2(n2.length) && !!B2[en2(n2)];
      }
      function Xs2(n2) {
        return typeof n2 == "function" ? n2 : n2 == null ? fn : typeof n2 == "object" ? O5(n2) ? ks2(n2[0], n2[1]) : Vs2(n2) : _a(n2);
      }
      function kr(n2) {
        if (!ce4(n2))
          return Lf(n2);
      ...
      function ks2(n2, t) {
        return vi(n2) && bu(t) ? Tu(Wn(n2), t) : function(e) {
          var r = yi(e, n2);
          return r === i2 && r === t ? Si2(e, n2) : ae4(t, r, It2 | de3);
        };
      }
      function Ge3(n2, t, e, r, s) {
        n2 !== t && Zr(t, function(o, f4) {
          if (s || (s = new Rn2()), z3(o))
            Tc(n2, t, f4, e, Ge3, r, s);
          else {
            var c2 = r ? r(mi(n2, f4), o, f4 + "", n2, t, s) : i2;
            c2 === i2 && (c2 = o), Kr(n2, f4, c2);
          }
        }, on2);
      }
      function Tc(n2, t, e, r, s, o, f4) {
        var c2 = mi(n2, e), l = mi(t, e), v2 = f4.get(l);
        if (v2) {
          Kr(n2, e, v2);
          return;
        }
        var _3 = o ? o(c2, l, e + "", n2, t, f4) : i2, m3 = _3 === i2;
        if (m3) {
          var w4 = O5(l), A = !w4 && at3(l), E4 = !w4 && !A && Mt3(l);
          _3 = l, w4 || A || E4 ? O5(c2) ? _3 = c2 : Y2(c2) ? _3 = un2(c2) : A ? (m3 = false, _3 = cu(l, true)) : E4 ? (m3 = false, _3 = hu(l, true)) : _3 = [] : le2(l) || wt3(l) ? (_3 = c2, wt3(c2) ? _3 = aa(c2) : (!z3(c2) || Xn2(c2)) && (_3 = Ru(l))) : m3 = false;
        }
        m3 && (f4.set(l, _3), s(_3, l, r, o, f4), f4.delete(l)), Kr(n2, e, _3);
      }
      function js2(n2, t) {
        var e = n2.length;
        if (e)
      ...
      function nu(n2, t, e) {
        t.length ? t = G3(t, function(o) {
          return O5(o) ? function(f4) {
            return vt2(f4, o.length === 1 ? o[0] : o);
          } : o;
        }) : t = [fn];
        var r = -1;
        t = G3(t, hn2(x2()));
        var s = Qs2(n2, function(o, f4, c2) {
          var l = G3(t, function(v2) {
            return v2(o);
          });
          return { criteria: l, index: ++r, value: o };
        });
        return rf(s, function(o, f4) {
          return zc(o, f4, e);
        });
      }
      function Lc(n2, t) {
      ...
      function tu(n2, t, e) {
        for (var r = -1, s = t.length, o = {}; ++r < s; ) {
          var f4 = t[r], c2 = vt2(n2, f4);
          e(c2, f4) && oe4(o, st3(f4, n2), c2);
        }
        return o;
      }
      function Dc(n2) {
      ...
      function ni(n2, t, e, r) {
        var s = r ? ef : Rt3, o = -1, f4 = t.length, c2 = n2;
        for (n2 === t && (t = un2(t)), e && (c2 = G3(n2, hn2(e))); ++o < f4; )
          for (var l = 0, v2 = t[o], _3 = e ? e(v2) : v2; (l = s(c2, _3, l, r)) > -1; )
            c2 !== n2 && De3.call(c2, l, 1), De3.call(n2, l, 1);
        return n2;
      }
      function eu(n2, t) {
      ...
      function ti(n2, t) {
        return n2 + $e4($s2() * (t - n2 + 1));
      }
      function Nc(n2, t, e, r) {
        for (var s = -1, o = Q4(He3((t - n2) / (e || 1)), 0), f4 = d2(o); o--; )
          f4[r ? o : ++s] = n2, n2 += e;
        return f4;
      }
      function ei(n2, t) {
      ...
      function oe4(n2, t, e, r) {
        if (!z3(n2))
          return n2;
        t = st3(t, n2);
        for (var s = -1, o = t.length, f4 = o - 1, c2 = n2; c2 != null && ++s < o; ) {
          var l = Wn(t[s]), v2 = e;
          if (l === "__proto__" || l === "constructor" || l === "prototype")
            return n2;
          if (s != f4) {
            var _3 = c2[l];
            v2 = r ? r(_3, l, c2) : i2, v2 === i2 && (v2 = z3(_3) ? _3 : Jn(t[s + 1]) ? [] : {});
          }
          ie3(c2, l, v2), c2 = c2[l];
        }
        return n2;
      ...
      function ze3(n2, t, e) {
        ...
        if (typeof t == "number" && t === t && s <= Fa) {
          for (; r < s; ) {
            var o = r + s >>> 1, f4 = n2[o];
            f4 !== null && !pn2(f4) && (e ? f4 <= t : f4 < t) ? r = o + 1 : s = o;
          }
          return s;
        }
        return ri(n2, t, fn, e);
      ...
      function ri(n2, t, e, r) {
        ...
        if (o === 0)
          return 0;
        t = e(t);
        for (var f4 = t !== t, c2 = t === null, l = pn2(t), v2 = t === i2; s < o; ) {
          var _3 = $e4((s + o) / 2), m3 = e(n2[_3]), w4 = m3 !== i2, A = m3 === null, E4 = m3 === m3, b5 = pn2(m3);
          if (f4)
            var y3 = r || E4;
          else
            v2 ? y3 = E4 && (r || w4) : c2 ? y3 = E4 && w4 && (r || !A) : l ? y3 = E4 && w4 && !A && (r || !b5) : A || b5 ? y3 = false : y3 = r ? m3 <= t : m3 < t;
          y3 ? s = _3 + 1 : o = _3;
        }
        return nn2(o, Wa);
      }
      ...
      function su(n2) {
        return typeof n2 == "number" ? n2 : pn2(n2) ? ge3 : +n2;
      }
      function ln(n2) {
        if (typeof n2 == "string")
          return n2;
      ...
      function it3(n2, t, e) {
        var r = -1, s = Ie3, o = n2.length, f4 = true, c2 = [], l = c2;
        if (e)
          f4 = false, s = Lr;
        else if (o >= I2) {
          var v2 = t ? null : Qc(n2);
          if (v2)
            return Ee(v2);
          f4 = false, s = kt3, l = new dt3();
        } else
          l = t ? [] : c2;
        n:
          for (; ++r < o; ) {
            var _3 = n2[r], m3 = t ? t(_3) : _3;
            if (_3 = e || _3 !== 0 ? _3 : 0, f4 && m3 === m3) {
      ...
      function si(n2, t, e) {
        ...
        for (var s = -1, o = d2(r); ++s < r; )
          for (var f4 = n2[s], c2 = -1; ++c2 < r; )
            c2 != s && (o[s] = se3(o[s] || f4, n2[c2], t, e));
        return it3(j5(o, 1), t, e);
      }
      function ou(n2, t, e) {
        for (var r = -1, s = n2.length, o = t.length, f4 = {}; ++r < s; ) {
          var c2 = r < o ? t[r] : i2;
          e(f4, n2[r], c2);
        }
        return f4;
      ...
      function st3(n2, t) {
        return O5(n2) ? n2 : vi(n2, t) ? [n2] : Uu(U4(n2));
      }
      var Mc = T;
      function ut3(n2, t, e) {
        var r = n2.length;
      ...
      function lu(n2, t) {
        if (n2 !== t) {
          var e = n2 !== i2, r = n2 === null, s = n2 === n2, o = pn2(n2), f4 = t !== i2, c2 = t === null, l = t === t, v2 = pn2(t);
          if (!c2 && !v2 && !o && n2 > t || o && f4 && l && !c2 && !v2 || r && f4 && l || !e && l || !s)
            return 1;
          if (!r && !o && !v2 && n2 < t || v2 && e && s && !r && !o || c2 && e && s || !f4 && s || !l)
            return -1;
        }
        return 0;
      }
      function zc(n2, t, e) {
        for (var r = -1, s = n2.criteria, o = t.criteria, f4 = s.length, c2 = e.length; ++r < f4; ) {
          var l = lu(s[r], o[r]);
          if (l) {
            if (r >= c2)
              return l;
      ...
      function pu(n2, t, e, r) {
        for (var s = -1, o = n2.length, f4 = e.length, c2 = -1, l = t.length, v2 = Q4(o - f4, 0), _3 = d2(l + v2), m3 = !r; ++c2 < l; )
          _3[c2] = t[c2];
        for (; ++s < f4; )
          (m3 || s < o) && (_3[e[s]] = n2[s]);
        for (; v2--; )
      ...
      function du(n2, t, e, r) {
        for (var s = -1, o = n2.length, f4 = -1, c2 = e.length, l = -1, v2 = t.length, _3 = Q4(o - c2, 0), m3 = d2(_3 + v2), w4 = !r; ++s < _3; )
          m3[s] = n2[s];
        for (var A = s; ++l < v2; )
          m3[A + l] = t[l];
        for (; ++f4 < c2; )
          (w4 || s < o) && (m3[A + e[f4]] = n2[s++]);
        return m3;
      }
      function un2(n2, t) {
        var e = -1, r = n2.length;
      ...
      function Ye3(n2, t) {
        return function(e, r) {
          var s = O5(e) ? Qo : dc, o = t ? t() : {};
          return s(e, n2, x2(r, 2), o);
        };
      }
      function Ut3(n2) {
        return T(function(t, e) {
          var r = -1, s = e.length, o = s > 1 ? e[s - 1] : i2, f4 = s > 2 ? e[2] : i2;
          for (o = n2.length > 3 && typeof o == "function" ? (s--, o) : i2, f4 && rn2(e[0], e[1], f4) && (o = s < 3 ? i2 : o, s = 1), t = M4(t); ++r < s; ) {
            var c2 = e[r];
            c2 && n2(t, c2, r, o);
          }
          return t;
      ...
      function gu(n2, t) {
        return function(e, r) {
          ...
          if (!an2(e))
            return n2(e, r);
          for (var s = e.length, o = t ? s : -1, f4 = M4(e); (t ? o-- : ++o < s) && r(f4[o], o, f4) !== false; )
            ;
          return e;
        };
      }
      function vu(n2) {
        return function(t, e, r) {
          for (var s = -1, o = M4(t), f4 = r(t), c2 = f4.length; c2--; ) {
            var l = f4[n2 ? c2 : ++s];
            if (e(o[l], l, o) === false)
              break;
          }
      ...
      function Zc(n2, t, e) {
        var r = t & vn2, s = fe2(n2);
        function o() {
          var f4 = this && this !== k2 && this instanceof o ? s : n2;
          return f4.apply(r ? e : this, arguments);
        }
        return o;
      }
      function _u(n2) {
      ...
      function Jc(n2, t, e) {
        var r = fe2(n2);
        function s() {
          for (var o = arguments.length, f4 = d2(o), c2 = o, l = Ft3(s); c2--; )
            f4[c2] = arguments[c2];
          var v2 = o < 3 && f4[0] !== l && f4[o - 1] !== l ? [] : tt3(f4, l);
          if (o -= v2.length, o < e)
            return Cu(n2, t, Ze4, s.placeholder, i2, f4, v2, i2, i2, e - o);
        ...
        return Zn(function(t) {
          ...
          for (n2 && t.reverse(); r--; ) {
            ...
            if (typeof o != "function")
              throw new wn2(F2);
            if (s && !f4 && Ve3(o) == "wrapper")
              var f4 = new Pn([], true);
          }
          for (r = f4 ? r : e; ++r < e; ) {
            o = t[r];
            var c2 = Ve3(o), l = c2 == "wrapper" ? pi(o) : i2;
            l && _i(l[0]) && l[1] == (qn2 | Dn2 | Nn | zt3) && !l[4].length && l[9] == 1 ? f4 = f4[Ve3(l[0])].apply(f4, l[3]) : f4 = o.length == 1 && _i(o) ? f4[c2]() : f4.thru(o);
          }
          return function() {
            var v2 = arguments, _3 = v2[0];
            if (f4 && v2.length == 1 && O5(_3))
              return f4.plant(_3).value();
            for (var m3 = 0, w4 = e ? t[m3].apply(this, v2) : _3; ++m3 < e; )
              w4 = t[m3].call(this, w4);
            return w4;
          };
        });
      }
      function Ze4(n2, t, e, r, s, o, f4, c2, l, v2) {
        var _3 = t & qn2, m3 = t & vn2, w4 = t & ft3, A = t & (Dn2 | xt3), E4 = t & pr2, b5 = w4 ? i2 : fe2(n2);
        function y3() {
          for (var L4 = arguments.length, H4 = d2(L4), dn = L4; dn--; )
            H4[dn] = arguments[dn];
          if (A)
            var sn2 = Ft3(y3), gn = uf(H4, sn2);
          if (r && (H4 = pu(H4, r, s, A)), o && (H4 = du(H4, o, f4, A)), L4 -= gn, A && L4 < v2) {
            var Z4 = tt3(H4, sn2);
            return Cu(n2, t, Ze4, y3.placeholder, e, H4, Z4, c2, l, v2 - L4);
          }
          var Tn = m3 ? e : this, Vn2 = w4 ? Tn[n2] : n2;
          return L4 = H4.length, c2 ? H4 = dh(H4, c2) : E4 && L4 > 1 && H4.reverse(), _3 && l < L4 && (H4.length = l), this && this !== k2 && this instanceof y3 && (Vn2 = b5 || fe2(Vn2)), Vn2.apply(Tn, H4);
        }
        return y3;
      }
      function Pu(n2, t) {
      ...
      function fi(n2) {
        return Zn(function(t) {
          return t = G3(t, hn2(x2())), T(function(e) {
            var r = this;
      ...
      function Xc(n2, t, e, r) {
        var s = t & vn2, o = fe2(n2);
        function f4() {
          for (var c2 = -1, l = arguments.length, v2 = -1, _3 = r.length, m3 = d2(_3 + l), w4 = this && this !== k2 && this instanceof f4 ? o : n2; ++v2 < _3; )
            m3[v2] = r[v2];
          for (; l--; )
            m3[v2++] = arguments[++c2];
      ...
      function Cu(n2, t, e, r, s, o, f4, c2, l, v2) {
        var _3 = t & Dn2, m3 = _3 ? f4 : i2, w4 = _3 ? i2 : f4, A = _3 ? o : i2, E4 = _3 ? i2 : o;
        t |= _3 ? Nn : Et2, t &= ~(_3 ? Et2 : Nn), t & Mi2 || (t &= ~(vn2 | ft3));
        var b5 = [n2, t, s, A, m3, E4, w4, c2, l, v2], y3 = e.apply(i2, b5);
        return _i(n2) && Nu(y3, b5), y3.placeholder = r, Hu(y3, n2, t);
      }
      function ci(n2) {
        var t = X3[n2];
        return function(e, r) {
          if (e = xn(e), r = r == null ? 0 : nn2(R2(r), 292), r && Hs2(e)) {
            var s = (U4(e) + "e").split("e"), o = t(s[0] + "e" + (+s[1] + r));
            return s = (U4(o) + "e").split("e"), +(s[0] + "e" + (+s[1] - r));
          }
          return t(e);
        };
      }
      ...
      function Yn2(n2, t, e, r, s, o, f4, c2) {
        var l = t & ft3;
        if (!l && typeof n2 != "function")
          throw new wn2(F2);
        var v2 = r ? r.length : 0;
        if (v2 || (t &= ~(Nn | Et2), r = s = i2), f4 = f4 === i2 ? f4 : Q4(R2(f4), 0), c2 = c2 === i2 ? c2 : R2(c2), v2 -= s ? s.length : 0, t & Et2) {
          var _3 = r, m3 = s;
          r = s = i2;
        }
        var w4 = l ? i2 : pi(n2), A = [n2, t, e, r, s, _3, m3, o, f4, c2];
        if (w4 && hh(A, w4), n2 = A[0], t = A[1], e = A[2], r = A[3], s = A[4], c2 = A[9] = A[9] === i2 ? l ? 0 : n2.length : Q4(A[9] - v2, 0), !c2 && t & (Dn2 | xt3) && (t &= ~(Dn2 | xt3)), !t || t == vn2)
          var E4 = Zc(n2, t, e);
        else
          t == Dn2 || t == xt3 ? E4 = Jc(n2, t, c2) : (t == Nn || t == (vn2 | Nn)) && !s.length ? E4 = Xc(n2, t, e, r) : E4 = Ze4.apply(i2, A);
        var b5 = w4 ? ru : Nu;
        return Hu(b5(E4, A), n2, t);
      }
      ...
      function yu(n2, t, e, r, s, o) {
        var f4 = e & It2, c2 = n2.length, l = t.length;
        if (c2 != l && !(f4 && l > c2))
          return false;
        var v2 = o.get(n2), _3 = o.get(t);
        if (v2 && _3)
          return v2 == t && _3 == n2;
        var m3 = -1, w4 = true, A = e & de3 ? new dt3() : i2;
        for (o.set(n2, t), o.set(t, n2); ++m3 < c2; ) {
          var E4 = n2[m3], b5 = t[m3];
          if (r)
            var y3 = f4 ? r(b5, E4, m3, t, n2, o) : r(E4, b5, m3, n2, t, o);
          if (y3 !== i2) {
            if (y3)
              continue;
            w4 = false;
          ...
          if (A) {
            if (!Nr(t, function(L4, H4) {
              if (!kt3(A, H4) && (E4 === L4 || s(E4, L4, e, r, o)))
                return A.push(H4);
            })) {
              w4 = false;
              break;
            }
          } else if (!(E4 === b5 || s(E4, b5, e, r, o))) {
            w4 = false;
            break;
          }
        }
        return o.delete(n2), o.delete(t), w4;
      }
      function kc(n2, t, e, r, s, o, f4) {
        switch (e) {
          case St3:
          ...
          case Sn:
            var l = r & It2;
            if (c2 || (c2 = Ee), n2.size != t.size && !l)
              return false;
            var v2 = f4.get(n2);
            if (v2)
              return v2 == t;
            r |= de3, f4.set(n2, t);
            var _3 = yu(c2(n2), c2(t), r, s, o, f4);
      ...
      function jc(n2, t, e, r, s, o) {
        var f4 = e & It2, c2 = hi(n2), l = c2.length, v2 = hi(t), _3 = v2.length;
        if (l != _3 && !f4)
          return false;
        for (var m3 = l; m3--; ) {
          var w4 = c2[m3];
          if (!(f4 ? w4 in t : W2.call(t, w4)))
            return false;
        }
        var A = o.get(n2), E4 = o.get(t);
        if (A && E4)
          return A == t && E4 == n2;
        var b5 = true;
        ...
        for (var y3 = f4; ++m3 < l; ) {
          w4 = c2[m3];
          var L4 = n2[w4], H4 = t[w4];
          if (r)
            var dn = f4 ? r(H4, L4, w4, t, n2, o) : r(L4, H4, w4, n2, t, o);
          if (!(dn === i2 ? L4 === H4 || s(L4, H4, e, r, o) : dn)) {
            b5 = false;
            break;
          }
          y3 || (y3 = w4 == "constructor");
        }
        if (b5 && !y3) {
      ...
      function Ou(n2, t, e) {
        ...
        for (var r = -1, s = t.length, o = false; ++r < s; ) {
          var f4 = Wn(t[r]);
          if (!(o = n2 != null && e(n2, f4)))
            break;
          n2 = n2[f4];
        }
        return o || ++r != s ? o : (s = n2 == null ? 0 : n2.length, !!s && sr2(s) && Jn(f4, s) && (O5(n2) || wt3(n2)));
      }
      function rh(n2) {
      ...
      function Ru(n2) {
        return typeof n2.constructor == "function" && !ce4(n2) ? $t3(Le2(n2)) : {};
      }
      function ih(n2, t, e) {
...
`);
      ...
      function uh(n2) {
        return O5(n2) || wt3(n2) || !!(Ns2 && n2 && n2[Ns2]);
      }
      function Jn(n2, t) {
        var e = typeof n2;
      ...
      function vi(n2, t) {
        if (O5(n2))
          return false;
        var e = typeof n2;
        return e == "number" || e == "symbol" || e == "boolean" || n2 == null || pn2(n2) ? true : to.test(n2) || !no.test(n2) || t != null && n2 in M4(t);
      }
      function ah(n2) {
        var t = typeof n2;
      ...
      function hh(n2, t) {
        var e = n2[1], r = t[1], s = e | r, o = s < (vn2 | ft3 | qn2), f4 = r == qn2 && e == Dn2 || r == qn2 && e == zt3 && n2[7].length <= t[8] || r == (qn2 | zt3) && t[7].length <= t[8] && e == Dn2;
        if (!(o || f4))
          return n2;
        r & vn2 && (n2[2] = t[2], s |= e & vn2 ? 0 : Mi2);
        var c2 = t[3];
        if (c2) {
          var l = n2[3];
          n2[3] = l ? pu(l, c2, t[4]) : c2, n2[4] = l ? tt3(n2[3], At3) : t[4];
        }
        return c2 = t[5], c2 && (l = n2[5], n2[5] = l ? du(l, c2, t[6]) : c2, n2[6] = l ? tt3(n2[5], At3) : t[6]), c2 = t[7], c2 && (n2[7] = c2), r & qn2 && (n2[8] = n2[8] == null ? t[8] : nn2(n2[8], t[8])), n2[9] == null && (n2[9] = t[9]), n2[0] = t[0], n2[1] = s, n2;
      }
      function lh(n2) {
        var t = [];
        if (n2 != null)
      ...
      function Lu(n2, t, e) {
        return t = Q4(t === i2 ? n2.length - 1 : t, 0), function() {
          for (var r = arguments, s = -1, o = Q4(r.length - t, 0), f4 = d2(o); ++s < o; )
            f4[s] = r[t + s];
          s = -1;
      ...
      function vh(n2, t, e) {
        (e ? rn2(n2, t, e) : t === i2) ? t = 1 : t = Q4(R2(t), 0);
        var r = n2 == null ? 0 : n2.length;
        if (!r || t < 1)
          return [];
        for (var s = 0, o = 0, f4 = d2(He3(r / t)); s < r; )
          f4[o++] = Cn2(n2, s, s += t);
        return f4;
      }
      function _h(n2) {
      ...
      var wh = T(function(n2, t) {
        return Y2(n2) ? se3(n2, j5(t, 1, Y2, true)) : [];
      }), Ph = T(function(n2, t) {
        var e = In(t);
        return Y2(e) && (e = i2), Y2(n2) ? se3(n2, j5(t, 1, Y2, true), x2(e, 2)) : [];
      }), Ah = T(function(n2, t) {
        var e = In(t);
        return Y2(e) && (e = i2), Y2(n2) ? se3(n2, j5(t, 1, Y2, true), i2, e) : [];
      });
      function Ch(n2, t, e) {
        var r = n2 == null ? 0 : n2.length;
      ...
      function xh(n2, t) {
        return n2 && n2.length ? Ke2(n2, x2(t, 3), true, true) : [];
      }
      function Eh(n2, t) {
        return n2 && n2.length ? Ke2(n2, x2(t, 3), true) : [];
      }
      ...
      function Fu(n2, t, e) {
        ...
        if (!r)
          return -1;
        var s = e == null ? 0 : R2(e);
        return s < 0 && (s = Q4(r + s, 0)), xe3(n2, x2(t, 3), s);
      }
      function Mu(n2, t, e) {
        var r = n2 == null ? 0 : n2.length;
        if (!r)
          return -1;
        var s = r - 1;
        return e !== i2 && (s = R2(e), s = e < 0 ? Q4(r + s, 0) : nn2(s, r - 1)), xe3(n2, x2(t, 3), s, true);
      }
      function qu(n2) {
      ...
      function $h(n2, t, e) {
        ...
        if (!r)
          return -1;
        var s = r;
        return e !== i2 && (s = R2(e), s = s < 0 ? Q4(r + s, 0) : nn2(s, r - 1)), t === t ? gf(n2, t, s) : xe3(n2, Cs2, s, true);
      }
      function Uh(n2, t) {
      ...
      function Vh(n2, t) {
        return n2 && n2.length ? iu(n2, x2(t, 2)) : [];
      }
      function kh(n2) {
        var t = n2 == null ? 0 : n2.length;
        return t ? Cn2(n2, 1, t) : [];
      ...
      function tl(n2, t) {
        return n2 && n2.length ? Ke2(n2, x2(t, 3), false, true) : [];
      }
      function el(n2, t) {
        return n2 && n2.length ? Ke2(n2, x2(t, 3)) : [];
      }
      var rl = T(function(n2) {
        return it3(j5(n2, 1, Y2, true));
      }), il = T(function(n2) {
        var t = In(n2);
        return Y2(t) && (t = i2), it3(j5(n2, 1, Y2, true), x2(t, 2));
      }), sl = T(function(n2) {
        var t = In(n2);
        return t = typeof t == "function" ? t : i2, it3(j5(n2, 1, Y2, true), i2, t);
      });
      function ul(n2) {
      ...
      var fl = T(function(n2, t) {
        return Y2(n2) ? se3(n2, t) : [];
      }), cl = T(function(n2) {
        return si(jn2(n2, Y2));
      }), hl = T(function(n2) {
        var t = In(n2);
        return Y2(t) && (t = i2), si(jn2(n2, Y2), x2(t, 2));
      }), ll = T(function(n2) {
        var t = In(n2);
        return t = typeof t == "function" ? t : i2, si(jn2(n2, Y2), i2, t);
      }), pl = T(Ai);
      function dl(n2, t) {
        return ou(n2 || [], t || [], ie3);
      }
      ...
      var ml = Zn(function(n2) {
        ...
        return t > 1 || this.__actions__.length || !(r instanceof N12) || !Jn(e) ? this.thru(s) : (r = r.slice(e, +e + (t ? 1 : 0)), r.__actions__.push({ func: nr2, args: [s], thisArg: i2 }), new Pn(r, this.__chain__).thru(function(o) {
      ...
      function xl() {
        ...
        if (n2 instanceof N12) {
          var t = n2;
          return this.__actions__.length && (t = new N12(this)), t = t.reverse(), t.__actions__.push({ func: nr2, args: [Pi2], thisArg: i2 }), new Pn(t, this.__chain__);
        }
      ...
      function Hl(n2, t, e, r) {
        ...
        var s = n2.length;
        return e < 0 && (e = Q4(s + e, 0)), ur(n2) ? e <= s && n2.indexOf(t, e) > -1 : !!s && Rt3(n2, t, e) > -1;
      }
      var $l = T(function(n2, t, e) {
        var r = -1, s = typeof t == "function", o = an2(n2) ? d2(n2.length) : [];
        return rt3(n2, function(f4) {
          o[++r] = s ? cn2(t, f4, e) : ue4(f4, t, e);
        }), o;
      ...
      function Wl(n2, t, e, r) {
        return n2 == null ? [] : (O5(t) || (t = t == null ? [] : [t]), e = r ? i2 : e, O5(e) || (e = e == null ? [] : [e]), nu(n2, t, e));
      }
      ...
      function ql(n2, t, e) {
        var r = O5(n2) ? ko : xs2, s = arguments.length < 3;
        return r(n2, x2(t, 4), e, s, Gs2);
      }
      function Bl(n2, t) {
        var e = O5(n2) ? jn2 : zs2;
        return e(n2, ir2(x2(t, 3)));
      }
      function Gl(n2) {
        var t = O5(n2) ? Fs2 : Hc;
        return t(n2);
      ...
      function ju(n2, t, e) {
        var r, s, o, f4, c2, l, v2 = 0, _3 = false, m3 = false, w4 = true;
        if (typeof n2 != "function")
          throw new wn2(F2);
        t = xn(t) || 0, z3(e) && (_3 = !!e.leading, m3 = "maxWait" in e, o = m3 ? Q4(xn(e.maxWait) || 0, t) : o, w4 = "trailing" in e ? !!e.trailing : w4);
        function A(Z4) {
          var Tn = r, Vn2 = s;
          return r = s = i2, v2 = Z4, f4 = n2.apply(Vn2, Tn), f4;
        }
        function E4(Z4) {
          return v2 = Z4, c2 = he2(L4, t), _3 ? A(Z4) : f4;
        }
        function b5(Z4) {
          var Tn = Z4 - l, Vn2 = Z4 - v2, ma = t - Tn;
          return m3 ? nn2(ma, o - Vn2) : ma;
        }
        function y3(Z4) {
          var Tn = Z4 - l, Vn2 = Z4 - v2;
          return l === i2 || Tn >= t || Tn < 0 || m3 && Vn2 >= o;
        }
        function L4() {
          var Z4 = er2();
          if (y3(Z4))
        ...
        function H4(Z4) {
          return c2 = i2, w4 && r ? A(Z4) : (r = s = i2, f4);
        }
        function dn() {
          c2 !== i2 && fu(c2), v2 = 0, r = l = s = c2 = i2;
        }
        function sn2() {
          return c2 === i2 ? f4 : H4(er2());
        }
        function gn() {
          var Z4 = er2(), Tn = y3(Z4);
          if (r = arguments, s = this, l = Z4, Tn) {
            if (c2 === i2)
              return E4(l);
            if (m3)
              return fu(c2), c2 = he2(L4, t), A(l);
          }
          return c2 === i2 && (c2 = he2(L4, t)), f4;
        }
      ...
      function rr2(n2, t) {
        ...
        var e = function() {
          ...
          if (o.has(s))
            return o.get(s);
          var f4 = n2.apply(this, r);
          return e.cache = o.set(s, f4) || o, f4;
        };
      ...
      var np = Mc(function(n2, t) {
        t = t.length == 1 && O5(t[0]) ? G3(t[0], hn2(x2())) : G3(j5(t, 1), hn2(x2()));
        var e = t.length;
        return T(function(r) {
      ...
      function rp(n2, t) {
        if (typeof n2 != "function")
          throw new wn2(F2);
        return t = t == null ? 0 : Q4(R2(t), 0), T(function(e) {
      ...
      var pp = Qe3(Xr), dp = Qe3(function(n2, t) {
        return n2 >= t;
      }), wt3 = Zs2(function() {
        return arguments;
      }()) ? Zs2 : function(n2) {
        return K2(n2) && W2.call(n2, "callee") && !Ds2.call(n2, "callee");
      }, O5 = d2.isArray, gp = ds2 ? hn2(ds2) : Ic;
      function an2(n2) {
      ...
      function wp(n2) {
        if (n2 == null)
          return true;
        if (an2(n2) && (O5(n2) || typeof n2 == "string" || typeof n2.splice == "function" || at3(n2) || Mt3(n2) || wt3(n2)))
          return !n2.length;
        var t = tn2(n2);
        if (t == yn || t == Sn)
          return !n2.size;
      ...
      function xi(n2) {
        if (!K2(n2))
          return false;
        var t = en2(n2);
        return t == _e2 || t == Ba || typeof n2.message == "string" && typeof n2.name == "string" && !le2(n2);
      }
      function Cp(n2) {
      ...
      function ra(n2) {
        return typeof n2 == "number" || K2(n2) && en2(n2) == Zt;
      }
      function le2(n2) {
        if (!K2(n2) || en2(n2) != Bn2)
          return false;
      ...
      function ur(n2) {
        return typeof n2 == "string" || !O5(n2) && K2(n2) && en2(n2) == Xt;
      }
      function pn2(n2) {
        return typeof n2 == "symbol" || K2(n2) && en2(n2) == we3;
      }
      var Mt3 = ws2 ? hn2(ws2) : Rc;
      function bp(n2) {
        return n2 === i2;
      }
      function Tp(n2) {
        return K2(n2) && tn2(n2) == Qt;
      }
      function Lp(n2) {
        return K2(n2) && en2(n2) == Ya;
      }
      var Dp = Qe3(jr), Np = Qe3(function(n2, t) {
        return n2 <= t;
      });
      function sa(n2) {
        if (!n2)
      ...
      function xn(n2) {
        ...
        n2 = Es2(n2);
        var e = po.test(n2);
        return e || vo.test(n2) ? Jo(n2.slice(2), e ? 2 : 8) : lo.test(n2) ? ge3 : +n2;
      }
      function aa(n2) {
      ...
      var Mp = T(function(n2, t) {
        ...
        for (s && rn2(t[0], t[1], s) && (r = 1); ++e < r; )
          for (var o = t[e], f4 = on2(o), c2 = -1, l = f4.length; ++c2 < l; ) {
            var v2 = f4[c2], _3 = n2[v2];
            (_3 === i2 || bn(_3, Dt3[v2]) && !W2.call(n2, v2)) && (n2[v2] = o[v2]);
          }
        return n2;
      }), qp = T(function(n2) {
      ...
      function Bp(n2, t) {
        return As2(n2, x2(t, 3), $n2);
      }
      function Gp(n2, t) {
        return As2(n2, x2(t, 3), Jr);
      }
      function zp(n2, t) {
        return n2 == null ? n2 : Zr(n2, x2(t, 3), on2);
      }
      function Kp(n2, t) {
        return n2 == null ? n2 : Ks2(n2, x2(t, 3), on2);
      }
      function Yp(n2, t) {
        return n2 && $n2(n2, x2(t, 3));
      }
      function Zp(n2, t) {
      ...
      function nd(n2, t) {
        var e = {};
        return t = x2(t, 3), $n2(n2, function(r, s, o) {
          Kn2(e, t(r, s, o), r);
        }), e;
      }
      function td(n2, t) {
      ...
      function ca(n2, t) {
        ...
        return t = x2(t), tu(n2, e, function(r, s) {
          return t(r, s[0]);
        });
      }
      function ud(n2, t, e) {
      ...
      var ha = Iu(V2), la = Iu(on2);
      function fd(n2, t, e) {
        var r = O5(n2), s = r || at3(n2) || Mt3(n2);
        if (t = x2(t, 4), e == null) {
          var o = n2 && n2.constructor;
          s ? e = r ? new o() : [] : z3(n2) ? e = Xn2(o) ? $t3(Le2(n2)) : {} : e = {};
        }
        return (s ? mn2 : $n2)(n2, function(f4, c2, l) {
          return t(e, f4, c2, l);
        }), e;
      }
      function cd(n2, t) {
      ...
      function pa(n2) {
        return Oi2(U4(n2).toLowerCase());
      }
      function da(n2) {
        return n2 = U4(n2), n2 && n2.replace(mo, af).replace(Uo, "");
      }
      function md(n2, t, e) {
        n2 = U4(n2), t = ln(t);
        var r = n2.length;
      ...
      function wd(n2) {
        return n2 = U4(n2), n2 && Va.test(n2) ? n2.replace(Ki2, of) : n2;
      }
      function Pd(n2) {
        return n2 = U4(n2), n2 && ro.test(n2) ? n2.replace(Ir2, "\\$&") : n2;
      }
      ...
      function xd(n2, t, e) {
        ...
        if (!t || r >= t)
          return n2;
        var s = (t - r) / 2;
        return Xe3($e4(s), e) + n2 + Xe3(He3(s), e);
      }
      function Ed(n2, t, e) {
        n2 = U4(n2), t = R2(t);
        var r = t ? Tt3(n2) : 0;
      ...
      function Sd(n2, t, e) {
        return e || t == null ? t = 0 : t && (t = +t), Nf(U4(n2).replace(xr, ""), t || 0);
      }
      function Od(n2, t, e) {
        return (e ? rn2(n2, t, e) : t === i2) ? t = 1 : t = R2(t), ei(U4(n2), t);
      }
      function Rd() {
      ...
      function Td(n2, t, e) {
        return e && typeof e != "number" && rn2(n2, t, e) && (t = e = i2), e = e === i2 ? Hn : e >>> 0, e ? (n2 = U4(n2), n2 && (typeof t == "string" || t != null && !Ei(t)) && (t = ln(t), !t && bt2(n2)) ? ut3(On2(n2), 0, e) : n2.split(t, e)) : [];
      }
      ...
      function Nd(n2, t, e) {
        ...
        e && rn2(n2, t, e) && (t = i2), n2 = U4(n2), t = ar2({}, t, r, xu);
        var s = ar2({}, t.imports, r.imports, xu), o = V2(s), f4 = Fr(s, o), c2, l, v2 = 0, _3 = t.interpolate || Pe2, m3 = "__p += '", w4 = qr((t.escape || Pe2).source + "|" + _3.source + "|" + (_3 === Yi2 ? ho : Pe2).source + "|" + (t.evaluate || Pe2).source + "|$", "g"), A = "//# sourceURL=" + (W2.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Bo + "]") + `
`;
        n2.replace(w4, function(y3, L4, H4, dn, sn2, gn) {
          return H4 || (H4 = dn), m3 += n2.slice(v2, gn).replace(wo, ff), L4 && (c2 = true, m3 += `' +
__e(` + L4 + `) +
'`), sn2 && (l = true, m3 += `';
` + sn2 + `;
__p += '`), H4 && (m3 += `' +
...
`;
        var E4 = W2.call(t, "variable") && t.variable;
        if (!E4)
          m3 = `with (obj) {
` + m3 + `
}
`;
          ...
          throw new S4(Fn2);
        m3 = (l ? m3.replace(Za, "") : m3).replace(Ja, "$1").replace(Xa, "$1;"), m3 = "function(" + (E4 || "obj") + `) {
` + (E4 ? "" : `obj || (obj = {});
...
`) + m3 + `return __p
        ...
        var b5 = va(function() {
          return $4(o, A + "return " + m3).apply(i2, f4);
        });
        if (b5.source = m3, xi(b5))
          throw b5;
        return b5;
      }
      function Hd(n2) {
      ...
      function Ud(n2, t, e) {
        ...
        if (!n2 || !(t = ln(t)))
          return n2;
        var r = On2(n2), s = On2(t), o = ys2(r, s), f4 = Ss2(r, s) + 1;
        return ut3(r, o, f4).join("");
      }
      function Wd(n2, t, e) {
        if (n2 = U4(n2), n2 && (e || t === i2))
      ...
      function Md(n2, t) {
        ...
        if (c2 < 1)
          return r;
        var l = f4 ? ut3(f4, 0, c2).join("") : n2.slice(0, c2);
        if (s === i2)
          return l + r;
        if (f4 && (c2 += l.length - c2), Ei(s)) {
          if (n2.slice(c2).search(s)) {
            var v2, _3 = l;
            for (s.global || (s = qr(s.source, U4(Zi2.exec(s)) + "g")), s.lastIndex = 0; v2 = s.exec(_3); )
              var m3 = v2.index;
      ...
      function qd(n2) {
        return n2 = U4(n2), n2 && Qa.test(n2) ? n2.replace(zi, vf) : n2;
      }
      var Bd = Wt(function(n2, t, e) {
        return n2 + (e ? " " : "") + t.toUpperCase();
      }), Oi2 = _u("toUpperCase");
      function ga(n2, t, e) {
        return n2 = U4(n2), t = e ? i2 : t, t === i2 ? hf(n2) ? wf(n2) : tf(n2) : n2.match(t) || [];
      }
      ...
      function Ti(n2, t, e) {
        ...
        e == null && !(z3(t) && (s.length || !r.length)) && (e = t, t = n2, n2 = this, s = Be2(t, V2(t)));
        var o = !(z3(e) && "chain" in e) || !!e.chain, f4 = Xn2(n2);
      ...
      var tg = fi(G3), eg = fi(Ps2), rg = fi(Nr);
      function _a(n2) {
      ...
      function hg(n2) {
        return O5(n2) ? G3(n2, Wn) : pn2(n2) ? [n2] : un2(Uu(U4(n2)));
      }
      function lg(n2) {
        var t = ++If;
        return U4(n2) + t;
      ...
      function mg(n2, t) {
        return n2 && n2.length ? qe3(n2, x2(t, 2), Xr) : i2;
      }
      function wg(n2) {
        return Is2(n2, fn);
      }
      function Pg(n2, t) {
        return Is2(n2, x2(t, 2));
      }
      function Ag(n2) {
        return n2 && n2.length ? qe3(n2, fn, jr) : i2;
      }
      function Cg(n2, t) {
        return n2 && n2.length ? qe3(n2, x2(t, 2), jr) : i2;
      }
      ...
      return a2.after = Xl, a2.ary = Ju, a2.assign = $p, a2.assignIn = oa, a2.assignInWith = ar2, a2.assignWith = Up, a2.at = Wp, a2.before = Xu, a2.bind = Ci, a2.bindAll = Gd, a2.bindKey = Qu, a2.castArray = ap, a2.chain = Ku, a2.chunk = vh, a2.compact = _h, a2.concat = mh, a2.cond = zd, a2.conforms = Kd, a2.constant = Ri, a2.countBy = yl, a2.create = Fp, a2.curry = Vu, a2.curryRight = ku, a2.debounce = ju, a2.defaults = Mp, a2.defaultsDeep = qp, a2.defer = Ql, a2.delay = Vl, a2.difference = wh, a2.differenceBy = Ph, a2.differenceWith = Ah, a2.drop = Ch, a2.dropRight = Ih, a2.dropRightWhile = xh, a2.dropWhile = Eh, a2.fill = yh, a2.filter = Ol, a2.flatMap = Tl, a2.flatMapDeep = Ll, a2.flatMapDepth = Dl, a2.flatten = qu, a2.flattenDeep = Sh, a2.flattenDepth = Oh, a2.flip = kl, a2.flow = Zd, a2.flowRight = Jd, a2.fromPairs = Rh, a2.functions = Jp, a2.functionsIn = Xp, a2.groupBy = Nl, a2.initial = Th, a2.intersection = Lh, a2.intersectionBy = Dh, a2.intersectionWith = Nh, a2.invert = Vp, a2.invertBy = kp, a2.invokeMap = $l, a2.iteratee = bi, a2.keyBy = Ul, a2.keys = V2, a2.keysIn = on2, a2.map = tr2, a2.mapKeys = nd, a2.mapValues = td, a2.matches = Xd, a2.matchesProperty = Qd, a2.memoize = rr2, a2.merge = ed, a2.mergeWith = fa, a2.method = Vd, a2.methodOf = kd, a2.mixin = Ti, a2.negate = ir2, a2.nthArg = ng, a2.omit = rd, a2.omitBy = id, a2.once = jl, a2.orderBy = Wl, a2.over = tg, a2.overArgs = np, a2.overEvery = eg, a2.overSome = rg, a2.partial = Ii, a2.partialRight = na, a2.partition = Fl, a2.pick = sd, a2.pickBy = ca, a2.property = _a, a2.propertyOf = ig, a2.pull = Wh, a2.pullAll = Gu, a2.pullAllBy = Fh, a2.pullAllWith = Mh, a2.pullAt = qh, a2.range = sg, a2.rangeRight = ug, a2.rearg = tp, a2.reject = Bl, a2.remove = Bh, a2.rest = ep, a2.reverse = Pi2, a2.sampleSize = zl, a2.set = ad, a2.setWith = od, a2.shuffle = Kl, a2.slice = Gh, a2.sortBy = Jl, a2.sortedUniq = Qh, a2.sortedUniqBy = Vh, a2.split = Td, a2.spread = rp, a2.tail = kh, a2.take = jh, a2.takeRight = nl, a2.takeRightWhile = tl, a2.takeWhile = el, a2.tap = _l, a2.throttle = ip, a2.thru = nr2, a2.toArray = sa, a2.toPairs = ha, a2.toPairsIn = la, a2.toPath = hg, a2.toPlainObject = aa, a2.transform = fd, a2.unary = sp, a2.union = rl, a2.unionBy = il, a2.unionWith = sl, a2.uniq = ul, a2.uniqBy = al, a2.uniqWith = ol, a2.unset = cd, a2.unzip = Ai, a2.unzipWith = zu, a2.update = hd, a2.updateWith = ld, a2.values = qt2, a2.valuesIn = pd, a2.without = fl, a2.words = ga, a2.wrap = up, a2.xor = cl, a2.xorBy = hl, a2.xorWith = ll, a2.zip = pl, a2.zipObject = dl, a2.zipObjectDeep = gl, a2.zipWith = vl, a2.entries = ha, a2.entriesIn = la, a2.extend = oa, a2.extendWith = ar2, Ti(a2, a2), a2.add = pg, a2.attempt = va, a2.camelCase = _d, a2.capitalize = pa, a2.ceil = dg, a2.clamp = dd, a2.clone = op, a2.cloneDeep = cp, a2.cloneDeepWith = hp, a2.cloneWith = fp, a2.conformsTo = lp, a2.deburr = da, a2.defaultTo = Yd, a2.divide = gg, a2.endsWith = md, a2.eq = bn, a2.escape = wd, a2.escapeRegExp = Pd, a2.every = Sl, a2.find = Rl, a2.findIndex = Fu, a2.findKey = Bp, a2.findLast = bl, a2.findLastIndex = Mu, a2.findLastKey = Gp, a2.floor = vg, a2.forEach = Yu, a2.forEachRight = Zu, a2.forIn = zp, a2.forInRight = Kp, a2.forOwn = Yp, a2.forOwnRight = Zp, a2.get = yi, a2.gt = pp, a2.gte = dp, a2.has = Qp, a2.hasIn = Si2, a2.head = Bu, a2.identity = fn, a2.includes = Hl, a2.indexOf = bh, a2.inRange = gd, a2.invoke = jp, a2.isArguments = wt3, a2.isArray = O5, a2.isArrayBuffer = gp, a2.isArrayLike = an2, a2.isArrayLikeObject = Y2, a2.isBoolean = vp, a2.isBuffer = at3, a2.isDate = _p, a2.isElement = mp, a2.isEmpty = wp, a2.isEqual = Pp, a2.isEqualWith = Ap, a2.isError = xi, a2.isFinite = Cp, a2.isFunction = Xn2, a2.isInteger = ta, a2.isLength = sr2, a2.isMap = ea, a2.isMatch = Ip, a2.isMatchWith = xp, a2.isNaN = Ep, a2.isNative = yp, a2.isNil = Op, a2.isNull = Sp, a2.isNumber = ra, a2.isObject = z3, a2.isObjectLike = K2, a2.isPlainObject = le2, a2.isRegExp = Ei, a2.isSafeInteger = Rp, a2.isSet = ia, a2.isString = ur, a2.isSymbol = pn2, a2.isTypedArray = Mt3, a2.isUndefined = bp, a2.isWeakMap = Tp, a2.isWeakSet = Lp, a2.join = Hh, a2.kebabCase = Ad, a2.last = In, a2.lastIndexOf = $h, a2.lowerCase = Cd, a2.lowerFirst = Id, a2.lt = Dp, a2.lte = Np, a2.max = _g, a2.maxBy = mg, a2.mean = wg, a2.meanBy = Pg, a2.min = Ag, a2.minBy = Cg, a2.stubArray = Di, a2.stubFalse = Ni, a2.stubObject = ag, a2.stubString = og, a2.stubTrue = fg, a2.multiply = Ig, a2.nth = Uh, a2.noConflict = jd, a2.noop = Li2, a2.now = er2, a2.pad = xd, a2.padEnd = Ed, a2.padStart = yd, a2.parseInt = Sd, a2.random = vd, a2.reduce = Ml, a2.reduceRight = ql, a2.repeat = Od, a2.replace = Rd, a2.result = ud, a2.round = xg, a2.runInContext = h2, a2.sample = Gl, a2.size = Yl, a2.snakeCase = bd, a2.some = Zl, a2.sortedIndex = zh, a2.sortedIndexBy = Kh, a2.sortedIndexOf = Yh, a2.sortedLastIndex = Zh, a2.sortedLastIndexBy = Jh, a2.sortedLastIndexOf = Xh, a2.startCase = Ld, a2.startsWith = Dd, a2.subtract = Eg, a2.sum = yg, a2.sumBy = Sg, a2.template = Nd, a2.times = cg, a2.toFinite = Qn, a2.toInteger = R2, a2.toLength = ua, a2.toLower = Hd, a2.toNumber = xn, a2.toSafeInteger = Hp, a2.toString = U4, a2.toUpper = $d, a2.trim = Ud, a2.trimEnd = Wd, a2.trimStart = Fd, a2.truncate = Md, a2.unescape = qd, a2.uniqueId = lg, a2.upperCase = Bd, a2.upperFirst = Oi2, a2.each = Yu, a2.eachRight = Zu, a2.first = Bu, Ti(a2, function() {
        ...
        s && (a2.prototype[t] = function() {
          var f4 = this.__wrapped__, c2 = r ? [1] : arguments, l = f4 instanceof N12, v2 = c2[0], _3 = l || O5(f4), m3 = function(L4) {
            var H4 = s.apply(a2, nt3([L4], c2));
            return r && w4 ? H4[0] : H4;
          };
          _3 && e && typeof v2 == "function" && v2.length != 1 && (l = _3 = false);
          var w4 = this.__chain__, A = !!this.__actions__.length, E4 = o && !w4, b5 = l && !A;
          if (!o && _3) {
            f4 = b5 ? f4 : new N12(this);
            var y3 = n2.apply(f4, c2);
            return y3.__actions__.push({ func: nr2, args: [m3], thisArg: i2 }), new Pn(y3, w4);
          }
          return E4 && b5 ? n2.apply(this, c2) : (y3 = this.thru(m3), E4 ? r ? y3.value()[0] : y3.value() : y3);
        });
      }), mn2(["pop", "push", "shift", "sort", "splice", "unshift"], function(n2) {
        var t = ye2[n2], e = /^(?:push|sort|unshift)$/.test(n2) ? "tap" : "thru", r = /^(?:pop|shift)$/.test(n2);
      ...
      }), Ht2[Ze4(i2, ft3).name] = [{ name: "wrapper", func: i2 }], N12.prototype.clone = qf, N12.prototype.reverse = Bf, N12.prototype.value = Gf, a2.prototype.at = ml, a2.prototype.chain = wl, a2.prototype.commit = Pl, a2.prototype.next = Al, a2.prototype.plant = Il, a2.prototype.reverse = xl, a2.prototype.toJSON = a2.prototype.valueOf = a2.prototype.value = El, a2.prototype.first = a2.prototype.head, jt3 && (a2.prototype[jt3] = Cl), a2;
    }, Lt3 = Pf();
...
var Ea = (C4, u4, i2) => u4 in C4 ? Fg(C4, u4, { enumerable: true, configurable: true, writable: true, value: i2 }) : C4[u4] = i2;
var fr2 = (C4, u4) => {
  for (var i2 in u4 || (u4 = {}))
    Bg.call(u4, i2) && Ea(C4, i2, u4[i2]);
  if (xa)
    for (var i2 of xa(u4))
      Gg.call(u4, i2) && Ea(C4, i2, u4[i2]);
  return C4;
};
var zg = (C4, u4) => Mg(C4, qg(u4));
function En2(C4, u4, i2) {
  let p4;
  const I2 = Ui(C4);
  return u4.rpcMap && (p4 = u4.rpcMap[I2]), p4 || (p4 = `${Wg}?chainId=eip155:${I2}&projectId=${i2}`), p4;
}
function Ui(C4) {
...
function Kg(C4, u4) {
  const i2 = Object.keys(u4.namespaces).filter((I2) => I2.includes(C4));
  if (!i2.length)
    return [];
  const p4 = [];
  return i2.forEach((I2) => {
    const D3 = u4.namespaces[I2].accounts;
    p4.push(...D3);
  }), p4;
}
function Yg(C4 = {}, u4 = {}) {
  const i2 = Sa(C4), p4 = Sa(u4);
  return $i2.exports.merge(i2, p4);
}
function Sa(C4) {
  var u4, i2, p4, I2;
  const D3 = {};
  if (!H(C4))
    return D3;
  for (const [F2, Fn2] of Object.entries(C4)) {
    const Gt = te(F2) ? [F2] : Fn2.chains, lr2 = Fn2.methods || [], At3 = Fn2.events || [], Ln = Fn2.rpcMap || {}, Mn2 = Ze(F2);
    D3[Mn2] = zg(fr2(fr2({}, D3[Mn2]), Fn2), { chains: S(Gt, (u4 = D3[Mn2]) == null ? void 0 : u4.chains), methods: S(lr2, (i2 = D3[Mn2]) == null ? void 0 : i2.methods), events: S(At3, (p4 = D3[Mn2]) == null ? void 0 : p4.events), rpcMap: fr2(fr2({}, Ln), (I2 = D3[Mn2]) == null ? void 0 : I2.rpcMap) });
  }
  return D3;
}
function Zg(C4) {
...
function Jg(C4) {
  const u4 = {};
  for (const [i2, p4] of Object.entries(C4)) {
    const I2 = p4.methods || [], D3 = p4.events || [], F2 = p4.accounts || [], Fn2 = te(i2) ? [i2] : p4.chains ? p4.chains : ya(p4.accounts);
    u4[i2] = { chains: Fn2, methods: I2, events: D3, accounts: F2 };
  }
  return u4;
}
var Oa = {};
...
var Qg = class {
  ...
  setDefaultChain(u4, i2) {
    ...
    if (!this.httpProviders[p4]) {
      const I2 = i2 || En2(`${this.name}:${p4}`, this.namespace, this.client.core.projectId);
      if (!I2)
        throw new Error(`No RPC url provided for chainId: ${p4}`);
      this.setHttpProvider(p4, I2);
    }
    this.chainId = p4, this.events.emit(ot3.DEFAULT_CHAIN_CHANGED, `${this.name}:${p4}`);
  }
  requestAccounts() {
    return this.getAccounts();
  }
  ...
  async handleSwitchChain(u4) {
    var i2, p4;
    let I2 = u4.request.params ? (i2 = u4.request.params[0]) == null ? void 0 : i2.chainId : "0x0";
    I2 = I2.startsWith("0x") ? I2 : `0x${I2}`;
    const D3 = parseInt(I2, 16);
    if (this.isChainApproved(D3))
      this.setDefaultChain(`${D3}`);
    else if (this.namespace.methods.includes("wallet_switchEthereumChain"))
      await this.client.request({ topic: u4.topic, request: { method: u4.request.method, params: [{ chainId: I2 }] }, chainId: (p4 = this.namespace.chains) == null ? void 0 : p4[0] }), this.setDefaultChain(`${D3}`);
    else
      throw new Error(`Failed to switch to chain 'eip155:${D3}'. The chain is not approved or the wallet does not support 'wallet_switchEthereumChain' method.`);
    return null;
  }
  isChainApproved(u4) {
...
var ba = (C4, u4, i2) => u4 in C4 ? ev(C4, u4, { enumerable: true, configurable: true, writable: true, value: i2 }) : C4[u4] = i2;
var cr = (C4, u4) => {
  for (var i2 in u4 || (u4 = {}))
    sv.call(u4, i2) && ba(C4, i2, u4[i2]);
  if (Ra)
    for (var i2 of Ra(u4))
      uv.call(u4, i2) && ba(C4, i2, u4[i2]);
  return C4;
};
var Fi2 = (C4, u4) => rv(C4, iv(u4));
var hr = class _hr {
  constructor(u4) {
  ...
  async request(u4, i2) {
    const [p4, I2] = this.validateChain(i2);
    if (!this.session)
      throw new Error("Please call connect() before request()");
    return await this.getProvider(p4).request({ request: cr({}, u4), chainId: `${p4}:${I2}`, topic: this.session.topic });
  }
  sendAsync(u4, i2, p4) {
    this.request(u4, p4).then((I2) => i2(null, I2)).catch((I2) => i2(I2, void 0));
  }
  async enable() {
    if (!this.client)
  ...
  async pair(u4) {
    ...
    do {
      ...
      const { uri: p4, approval: I2 } = await this.client.connect({ pairingTopic: u4, requiredNamespaces: this.namespaces, optionalNamespaces: this.optionalNamespaces, sessionProperties: this.sessionProperties });
      p4 && (this.uri = p4, this.events.emit("display_uri", p4)), await I2().then((D3) => {
        this.session = D3, this.namespaces || (this.namespaces = Jg(D3.namespaces), this.persist("namespaces", this.namespaces));
      }).catch((D3) => {
        if (D3.message !== te2)
          throw D3;
        i2++;
  ...
  setDefaultChain(u4, i2) {
    try {
      if (!this.session)
        return;
      const [p4, I2] = this.validateChain(u4);
      this.getProvider(p4).setDefaultChain(I2, i2);
    } catch (p4) {
  ...
  async createClient() {
    this.client = this.providerOpts.client || await M2.init({ logger: this.providerOpts.logger || Ca, relayUrl: this.providerOpts.relayUrl || Hg, projectId: this.providerOpts.projectId, metadata: this.providerOpts.metadata, storageOptions: this.providerOpts.storageOptions, name: this.providerOpts.name }), this.logger.trace("SignClient Initialized");
  }
  createProviders() {
    if (!this.client)
      throw new Error("Sign Client not initialized");
    ...
    Wi2("client", this.client), Wi2("events", this.events), Wi2("disableProviderPing", this.disableProviderPing), u4.forEach((i2) => {
      if (!this.session)
        return;
      const p4 = Kg(i2, this.session), I2 = ya(p4), D3 = Yg(this.namespaces, this.optionalNamespaces), F2 = Fi2(cr({}, D3[i2]), { accounts: p4, chains: I2 });
      switch (i2) {
        case "eip155":
          this.rpcProviders[i2] = new Qg({ namespace: F2 });
          break;
        case "solana":
          this.rpcProviders[i2] = new Vg({ namespace: F2 });
          break;
        case "cosmos":
          this.rpcProviders[i2] = new kg({ namespace: F2 });
          break;
        case "polkadot":
          this.rpcProviders[i2] = new Xg({ namespace: F2 });
          break;
        case "cip34":
          this.rpcProviders[i2] = new jg({ namespace: F2 });
          break;
        case "elrond":
          this.rpcProviders[i2] = new nv({ namespace: F2 });
          break;
        case "multiversx":
          this.rpcProviders[i2] = new tv({ namespace: F2 });
          break;
      }
    });
  }
  registerEventListeners() {
    ...
    this.client.on("session_ping", (u4) => {
      ...
      if (p4.name === "accountsChanged") {
        const I2 = p4.data;
        I2 && C(I2) && this.events.emit("accountsChanged", I2.map(Zg));
      } else
        p4.name === "chainChanged" ? this.onChainChanged(i2.chainId) : this.events.emit(p4.name, p4.data);
      this.events.emit("session_event", u4);
    }), this.client.on("session_update", ({ topic: u4, params: i2 }) => {
      var p4;
      const { namespaces: I2 } = i2, D3 = (p4 = this.client) == null ? void 0 : p4.session.get(u4);
      this.session = Fi2(cr({}, D3), { namespaces: I2 }), this.onSessionUpdate(), this.events.emit("session_update", { topic: u4, params: i2 });
    }), this.client.on("session_delete", async (u4) => {
      await this.cleanup(), this.events.emit("session_delete", u4), this.events.emit("disconnect", Fi2(cr({}, w("USER_DISCONNECTED")), { data: u4.topic }));
  ...
  setNamespaces(u4) {
    const { namespaces: i2, optionalNamespaces: p4, sessionProperties: I2 } = u4;
    i2 && Object.keys(i2).length && (this.namespaces = i2), p4 && Object.keys(p4).length && (this.optionalNamespaces = p4), this.sessionProperties = I2, this.persist("namespaces", i2), this.persist("optionalNamespaces", p4);
  }
  validateChain(u4) {
    const [i2, p4] = (u4 == null ? void 0 : u4.split(":")) || ["", ""];
    if (!this.namespaces || !Object.keys(this.namespaces).length)
      return [i2, p4];
    if (i2 && !Object.keys(this.namespaces || {}).map((F2) => Ze(F2)).includes(i2))
      throw new Error(`Namespace '${i2}' is not configured. Please call connect() first with namespace config.`);
    if (i2 && p4)
      return [i2, p4];
    const I2 = Ze(Object.keys(this.namespaces)[0]), D3 = this.rpcProviders[I2].getDefaultChain();
    return [I2, D3];
  }
  ...
  onChainChanged(u4, i2 = false) {
    ...
    if (!this.namespaces)
      return;
    const [I2, D3] = this.validateChain(u4);
    i2 || this.getProvider(I2).setDefaultChain(D3), ((p4 = this.namespaces[I2]) != null ? p4 : this.namespaces[`${I2}:${D3}`]).defaultChain = D3, this.persist("namespaces", this.namespaces), this.events.emit("chainChanged", D3);
  }
  onConnect() {
...
var E3 = ["eth_accounts", "eth_requestAccounts", "eth_sendRawTransaction", "eth_sign", "eth_signTransaction", "eth_signTypedData", "eth_signTypedData_v3", "eth_signTypedData_v4", "wallet_switchEthereumChain", "wallet_addEthereumChain", "wallet_getPermissions", "wallet_requestPermissions", "wallet_registerOnboarding", "wallet_watchAsset", "wallet_scanQRCode"];
...
var O4 = (a2, t, s) => t in a2 ? N11(a2, t, { enumerable: true, configurable: true, writable: true, value: s }) : a2[t] = s;
var p3 = (a2, t) => {
  for (var s in t || (t = {}))
    U3.call(t, s) && O4(a2, s, t[s]);
  if (y2)
    for (var s of y2(t))
      Q3.call(t, s) && O4(a2, s, t[s]);
  return a2;
};
var M3 = (a2, t) => q3(a2, D2(t));
function g3(a2) {
...
function L3(a2) {
  const { chains: t, optionalChains: s, methods: i2, optionalMethods: n2, events: e, optionalEvents: h2, rpcMap: c2 } = a2;
  if (!C(t))
    throw new Error("Invalid chains");
  const o = { chains: t, methods: i2 || u3, events: e || m2, rpcMap: p3({}, t.length ? { [g3(t)]: c2[g3(t)] } : {}) }, r = e == null ? void 0 : e.filter((l) => !m2.includes(l)), d2 = i2 == null ? void 0 : i2.filter((l) => !u3.includes(l));
  if (!s && !h2 && !n2 && !(r != null && r.length) && !(d2 != null && d2.length))
    return { required: t.length ? o : void 0 };
  const C4 = (r == null ? void 0 : r.length) && (d2 == null ? void 0 : d2.length) || !s, I2 = { chains: [...new Set(C4 ? o.chains.concat(s || []) : s)], methods: [...new Set(o.methods.concat(n2 != null && n2.length ? n2 : E3))], events: [...new Set(o.events.concat(h2 || _2))], rpcMap: c2 };
...
var v = class _v {
  ...
  async connect(t) {
    ...
    try {
      ...
      this.setAccounts(e), this.events.emit("connect", { chainId: f3(this.chainId) });
    } catch (n2) {
  ...
  registerEventListeners() {
    this.signer.on("session_event", (t) => {
      ...
      this.reset(), this.events.emit("session_delete", t), this.events.emit("disconnect", M3(p3({}, w("USER_DISCONNECTED")), { data: t.topic, name: "USER_DISCONNECTED" }));
  ...
  getRpcConfig(t) {
    var s, i2;
    const n2 = (s = t == null ? void 0 : t.chains) != null ? s : [], e = (i2 = t == null ? void 0 : t.optionalChains) != null ? i2 : [], h2 = n2.concat(e);
    if (!h2.length)
      throw new Error("No chains specified in either `chains` or `optionalChains`");
    const c2 = n2.length ? (t == null ? void 0 : t.methods) || u3 : [], o = n2.length ? (t == null ? void 0 : t.events) || m2 : [], r = (t == null ? void 0 : t.optionalMethods) || [], d2 = (t == null ? void 0 : t.optionalEvents) || [], C4 = (t == null ? void 0 : t.rpcMap) || this.buildRpcMap(h2, t.projectId), I2 = (t == null ? void 0 : t.qrModalOptions) || void 0;
    return { chains: n2 == null ? void 0 : n2.map((l) => this.formatChainId(l)), optionalChains: e.map((l) => this.formatChainId(l)), methods: c2, events: o, optionalMethods: r, optionalEvents: d2, rpcMap: C4, showQrModal: !!(t != null && t.showQrModal), qrModalOptions: I2, projectId: t.projectId, metadata: t.metadata };
  }
  buildRpcMap(t, s) {
    const i2 = {};
    return t.forEach((n2) => {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? g3(this.rpc.chains) : g3(this.rpc.optionalChains), this.signer = await av.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s;
      try {
        const { WalletConnectModal: i2 } = await import("./dist-QFJAXCRX.js");
        s = i2;
      } catch {
...
@walletconnect/universal-provider/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=index.es-E2K7DVKY.js.map
